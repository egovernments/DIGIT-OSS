...
public class EgovMasterDataCaching {
    ...
    public List get(final String sqlTagName) throws ApplicationRuntimeException {
        ...
        HashMap<String, Object> cacheValuesHashMap = new HashMap<>();
