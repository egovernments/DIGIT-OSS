...
public class InboxRenderServiceDelegate<T extends StateAware> {
    ...
    /*
     * @Autowired
     * @Qualifier("eisService") private OwnerGroupService<? extends OwnerGroup> ownerGroupService;
     */
    ...
    /*
     * EIS dependency is removed in this branch. Actually should this API 
     * this.ownerGroupService.getOwnerGroupsByUserId(getUserId()) from EIS.
     * because of removing EIS dependency actual code and replaced with empty positions returning.
     * When you eis want to integrate at the time need to use commented code
     */
    private List<Long> currentUserPositionIds() {
       
        /*
         * return this.ownerGroupService.getOwnerGroupsByUserId(getUserId()) .parallelStream() .map(OwnerGroup::getId)
         * .collect(Collectors.toList());
         */
