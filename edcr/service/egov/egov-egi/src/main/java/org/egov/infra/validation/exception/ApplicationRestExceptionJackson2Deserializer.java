...
public class ApplicationRestExceptionJackson2Deserializer extends StdDeserializer<ApplicationRestException> {

    private static final String ERROR_DESCRIPTION = "error_description";

    public ApplicationRestExceptionJackson2Deserializer() {
        super(ApplicationRestException.class);
    }
    ...
    public ApplicationRestException deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException {
        ...
        String errorMessage = errorParams.get(ERROR_DESCRIPTION) != null ? errorParams.get(ERROR_DESCRIPTION).toString()
                : null;
        if (errorMessage == null) {
            errorMessage = errorCode == null ? "Rest Custom Error" : errorCode.toString();
        }
