...
public class PetrolFillingStation extends FeatureProcess {
	...
	// private static final String SUBRULE_59_10_DESC = "Minimum distance from
	// canopy to plot boundary";
	...
	public Plan process(Plan pl) {
		 ...
		 * scrutinyDetail.addColumnHeading(5, STATUS); if (pl != null &&
		 * pl.getVirtualBuilding() != null &&
		 * !pl.getVirtualBuilding().getOccupancies().isEmpty() &&
		 * pl.getVirtualBuilding().getOccupancies().contains(OccupancyType.OCCUPANCY_F4)
		 * &&
		 ...
		 * minimumCanopyDistanceFromPlotBoundary =
		 ...
		 * Math.round(minimumCanopyDistanceFromPlotBoundary.doubleValue() *
