...
public class MeanOfAccess extends FeatureProcess {
	...
	/*
	 * private static final String SUBRULE_57_5 = "57-5"; private static final
	 * String SUBRULE_58_3b = "58-3-b"; private static final String SUBRULE_59_4 =
	 * "59-4"; private static final String SUB_RULE_DESCRIPTION =
	 * "Minimum access width for plan for %s"; private static final String OCCUPANCY
	 * = "occupancy"; private static final String SUBRULE_33_1 = "33-1"; private
	 * static final BigDecimal VAL_300 = BigDecimal.valueOf(300); private static
	 * final BigDecimal VAL_600 = BigDecimal.valueOf(600); private static final
	 * BigDecimal VAL_1000 = BigDecimal.valueOf(1000); private static final
	 * BigDecimal VAL_8000 = BigDecimal.valueOf(8000); private static final
	 * BigDecimal VAL_18000 = BigDecimal.valueOf(18000); private static final
	 * BigDecimal VAL_24000 = BigDecimal.valueOf(24000); private static final
	 * BigDecimal VAL_1500 = BigDecimal.valueOf(1500); private static final
	 * BigDecimal VAL_6000 = BigDecimal.valueOf(6000); private static final
	 * BigDecimal VAL_12000 = BigDecimal.valueOf(12000); private static final String
	 * SUBRULE_116 = "116"; private static final String SUB_RULE_DES =
	...
	public Plan process(Plan pl) {
		 ...
		 * scrutinyDetail.addColumnHeading(7, REMARKS); String rule = ACCESS_WIDTH;
		 * String subRule = null; Boolean valid = false; boolean extemption =
		 * ProcessHelper.isSmallPlot(pl); if (!extemption) { BigDecimal
		 * totalFloorAreaOfAllBlocks = pl.getVirtualBuilding()!= null &&
	 ...
	 * String occupancy, String expected, String actual, String status, String
	 * remarks) { Map<String, String> details = new HashMap<>();
	 * details.put(RULE_NO, ruleNo); details.put(DESCRIPTION, ruleDesc);
	 * details.put(OCCPNCYCONDITION, occupancy); details.put(REQUIRED, expected);
	 * details.put(PROVIDED, actual); details.put(STATUS, status);
	 * details.put(REMARKS, remarks); scrutinyDetail.getDetail().add(details);
	 * pl.getReportOutput().getScrutinyDetails().add(scrutinyDetail); }
	 * 
	 * private String removeDuplicates(SortedSet<String> uniqueData) { StringBuilder
	 * str = new StringBuilder(); List<String> unqList = new
	 * ArrayList<>(uniqueData); for (String unique : unqList) { str.append(unique);
	 * if (!unique.equals(unqList.get(unqList.size() - 1))) { str.append(" , "); } }
	 * return str.toString(); }
	 */
