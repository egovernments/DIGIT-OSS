...
public class InteriorOpenSpace implements Serializable {
	...
	public void setVentilationShaft(MeasurementWithHeight ventilationShaft) {
		this.ventilationShaft = ventilationShaft;
	}

	public MeasurementWithHeight getInnerCourtYard() {
		return innerCourtYard;
	}

	public void setInnerCourtYard(MeasurementWithHeight innerCourtYard) {
		this.innerCourtYard = innerCourtYard;
	}
	...
	public void setOuterCourtYard(MeasurementWithHeight outerCourtYard) {
		this.outerCourtYard = outerCourtYard;
	}

	public MeasurementWithHeight getSunkenCourtYard() {
		return sunkenCourtYard;
	}

	public void setSunkenCourtYard(MeasurementWithHeight sunkenCourtYard) {
