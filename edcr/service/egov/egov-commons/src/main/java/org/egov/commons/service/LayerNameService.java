...
public class LayerNameService {
    ...
    public LayerName findByKey(String key) {
        return layerNameRepository.findByKey(key);
    }

    public LayerName findByValue(String value) {
        return layerNameRepository.findByValue(value);
    }
