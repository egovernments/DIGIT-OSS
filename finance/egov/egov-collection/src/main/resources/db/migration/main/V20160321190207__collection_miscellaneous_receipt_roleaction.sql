...
Insert into eg_roleaction (roleid,actionid) values ((select id from eg_role where name='SYSTEM'),(select id from eg_action where name='CreateMiscReceipts'));
...
INSERT INTO EG_ROLEACTION (ROLEID, ACTIONID) values ((select id from eg_role where name LIKE 'SYSTEM') ,(select id FROM eg_action  WHERE name = 'AjaxReceiptAccountDetailTypeService' and contextroot='collection'));
...
INSERT INTO EG_ROLEACTION (ROLEID, ACTIONID) values ((select id from eg_role where name LIKE 'SYSTEM') ,(select id FROM eg_action  WHERE name = 'AjaxServiceByCategory' and contextroot='collection'));
...
INSERT INTO EG_ROLEACTION (ROLEID, ACTIONID) values ((select id from eg_role where name LIKE 'SYSTEM') ,(select id FROM eg_action  WHERE name = 'AjaxFinMiscByService' and contextroot='collection'));
...
INSERT INTO EG_ROLEACTION (ROLEID, ACTIONID) values ((select id from eg_role where name LIKE 'SYSTEM') ,(select id FROM eg_action  WHERE name = 'AjaxFinAccDtlsByService' and contextroot='collection'));
...
INSERT INTO EG_ROLEACTION (ROLEID, ACTIONID) values ((select id from eg_role where name LIKE 'SYSTEM') ,(select id FROM eg_action  WHERE name = 'AjaxFinSubledgerByService' and contextroot='collection'));
