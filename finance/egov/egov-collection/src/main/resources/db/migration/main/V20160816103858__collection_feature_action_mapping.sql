...
INSERT INTO eg_feature_role (ROLE, FEATURE) VALUES ((select id from eg_role where name = 'SYSTEM') ,(select id FROM eg_feature WHERE name = 'Create Service Category'));
INSERT INTO eg_feature_role (ROLE, FEATURE) VALUES ((select id from eg_role where name = 'SYSTEM') ,(select id FROM eg_feature WHERE name = 'Modify Service Category'));
INSERT INTO eg_feature_role (ROLE, FEATURE) VALUES ((select id from eg_role where name = 'SYSTEM') ,(select id FROM eg_feature WHERE name = 'View Service Category'));
INSERT INTO eg_feature_role (ROLE, FEATURE) VALUES ((select id from eg_role where name = 'SYSTEM') ,(select id FROM eg_feature WHERE name = 'Create Service Details'));
INSERT INTO eg_feature_role (ROLE, FEATURE) VALUES ((select id from eg_role where name = 'SYSTEM') ,(select id FROM eg_feature WHERE name = 'Modify Service Details'));
INSERT INTO eg_feature_role (ROLE, FEATURE) VALUES ((select id from eg_role where name = 'SYSTEM') ,(select id FROM eg_feature WHERE name = 'View Service Details'));
INSERT INTO eg_feature_role (ROLE, FEATURE) VALUES ((select id from eg_role where name = 'SYSTEM') ,(select id FROM eg_feature WHERE name = 'Create Service To Bank Mapping'));
INSERT INTO eg_feature_role (ROLE, FEATURE) VALUES ((select id from eg_role where name = 'SYSTEM') ,(select id FROM eg_feature WHERE name = 'Modify Service To Bank Mapping'));
INSERT INTO eg_feature_role (ROLE, FEATURE) VALUES ((select id from eg_role where name = 'SYSTEM') ,(select id FROM eg_feature WHERE name = 'View Service To Bank Mapping'));
INSERT INTO eg_feature_role (ROLE, FEATURE) VALUES ((select id from eg_role where name = 'SYSTEM') ,(select id FROM eg_feature WHERE name = 'Miscelleneous Receipts'));
INSERT INTO eg_feature_role (ROLE, FEATURE) VALUES ((select id from eg_role where name = 'SYSTEM') ,(select id FROM eg_feature WHERE name = 'Challan Receipt'));
INSERT INTO eg_feature_role (ROLE, FEATURE) VALUES ((select id from eg_role where name = 'SYSTEM') ,(select id FROM eg_feature WHERE name = 'Search Receipts'));
INSERT INTO eg_feature_role (ROLE, FEATURE) VALUES ((select id from eg_role where name = 'SYSTEM') ,(select id FROM eg_feature WHERE name = 'Create Challan'));
INSERT INTO eg_feature_role (ROLE, FEATURE) VALUES ((select id from eg_role where name = 'SYSTEM') ,(select id FROM eg_feature WHERE name = 'Search Challan'));
INSERT INTO eg_feature_role (ROLE, FEATURE) VALUES ((select id from eg_role where name = 'SYSTEM') ,(select id FROM eg_feature WHERE name = 'Search Online Receipts'));
INSERT INTO eg_feature_role (ROLE, FEATURE) VALUES ((select id from eg_role where name = 'SYSTEM') ,(select id FROM eg_feature WHERE name = 'Cash Collection'));
INSERT INTO eg_feature_role (ROLE, FEATURE) VALUES ((select id from eg_role where name = 'SYSTEM') ,(select id FROM eg_feature WHERE name = 'Cheque Collection'));
INSERT INTO eg_feature_role (ROLE, FEATURE) VALUES ((select id from eg_role where name = 'SYSTEM') ,(select id FROM eg_feature WHERE name = 'Collection Summary'));
INSERT INTO eg_feature_role (ROLE, FEATURE) VALUES ((select id from eg_role where name = 'SYSTEM') ,(select id FROM eg_feature WHERE name = 'Property Tax Collection'));
INSERT INTO eg_feature_role (ROLE, FEATURE) VALUES ((select id from eg_role where name = 'SYSTEM') ,(select id FROM eg_feature WHERE name = 'Mutation Fee Payment'));
INSERT INTO eg_feature_role (ROLE, FEATURE) VALUES ((select id from eg_role where name = 'SYSTEM') ,(select id FROM eg_feature WHERE name = 'Collect Water Charges'));
INSERT INTO eg_feature_role (ROLE, FEATURE) VALUES ((select id from eg_role where name = 'SYSTEM') ,(select id FROM eg_feature WHERE name = 'Bank Remittance'));
INSERT INTO eg_feature_role (ROLE, FEATURE) VALUES ((select id from eg_role where name = 'SYSTEM') ,(select id FROM eg_feature WHERE name = 'Dishonored Cheque'));
INSERT INTO eg_feature_role (ROLE, FEATURE) VALUES ((select id from eg_role where name = 'SYSTEM') ,(select id FROM eg_feature WHERE name = 'Dishonored Cheque Report'));
INSERT INTO eg_feature_role (ROLE, FEATURE) VALUES ((select id from eg_role where name = 'SYSTEM') ,(select id FROM eg_feature WHERE name = 'Online Transaction Report'));
INSERT INTO eg_feature_role (ROLE, FEATURE) VALUES ((select id from eg_role where name = 'SYSTEM') ,(select id FROM eg_feature WHERE name = 'Remittance voucher Report'));
INSERT INTO eg_feature_role (ROLE, FEATURE) VALUES ((select id from eg_role where name = 'SYSTEM') ,(select id FROM eg_feature WHERE name = 'Bank Remittance Statement'));
INSERT INTO eg_feature_role (ROLE, FEATURE) VALUES ((select id from eg_role where name = 'SYSTEM') ,(select id FROM eg_feature WHERE name = 'Collection Summary-HeadWise Report'));
INSERT INTO eg_feature_role (ROLE, FEATURE) VALUES ((select id from eg_role where name = 'SYSTEM') ,(select id FROM eg_feature WHERE name = 'Receipt Register Report'));
