...
INSERT INTO EG_ROLEACTION (ROLEID, ACTIONID) values ((select id from eg_role where name LIKE 'SYSTEM') ,(select id FROM eg_action  WHERE name = 'CancelChallanReceipt' and contextroot='collection'));
...
INSERT INTO EG_ROLEACTION (ROLEID, ACTIONID) values ((select id from eg_role where name LIKE 'SYSTEM') ,(select id FROM eg_action  WHERE name = 'SaveCancelChallanReceipt' and contextroot='collection'));
