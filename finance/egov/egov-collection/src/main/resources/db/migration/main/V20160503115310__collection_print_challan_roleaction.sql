...
INSERT INTO EG_ROLEACTION (ROLEID,ACTIONID) VALUES ((SELECT ID FROM eg_role WHERE name='SYSTEM'),(SELECT ID FROM EG_ACTION WHERE NAME='RemittancePrintBankChallan'));
...
INSERT INTO EG_ROLEACTION (ROLEID,ACTIONID) VALUES ((SELECT ID FROM eg_role WHERE name='SYSTEM'),(SELECT ID FROM EG_ACTION WHERE NAME='RemittancePrintBankChallanReport'));
