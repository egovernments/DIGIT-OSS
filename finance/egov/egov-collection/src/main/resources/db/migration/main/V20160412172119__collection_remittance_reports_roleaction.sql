...
INSERT INTO EG_ROLEACTION (ROLEID,ACTIONID) VALUES ((SELECT ID FROM eg_role WHERE name='SYSTEM'),(SELECT ID FROM EG_ACTION WHERE NAME='RemittanceVoucherReport'));
...
INSERT INTO EG_ROLEACTION (ROLEID,ACTIONID) VALUES ((SELECT ID FROM eg_role WHERE name='SYSTEM'),(SELECT ID FROM EG_ACTION WHERE NAME='RemittanceVoucherReportResult'));
...
INSERT INTO EG_ROLEACTION (ROLEID,ACTIONID) VALUES ((SELECT ID FROM eg_role WHERE name='SYSTEM'),(SELECT ID FROM EG_ACTION WHERE NAME='RemittanceStatementReport'));
...
INSERT INTO EG_ROLEACTION (ROLEID,ACTIONID) VALUES ((SELECT ID FROM eg_role WHERE name='SYSTEM'),(SELECT ID FROM EG_ACTION WHERE NAME='RemittanceStatementReportResult'));
