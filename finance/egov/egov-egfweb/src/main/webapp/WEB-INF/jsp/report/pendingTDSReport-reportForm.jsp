...
function getData(){
	...
	if(isValid == false)
		return false;
	var url = '/services/EGF/report/pendingTDSReport-ajaxLoadData.action?skipPrepare=true&asOnDate='+asOnDate+'&fromDate='+fromDate+'&department.id='+
...
function exportXls(){
	...
	if(document.getElementById('showRemittedEntries').checked)
		...
		showRemittedEntries = false;
	window.open('/services/EGF/report/pendingTDSReport-exportXls.action?skipPrepare=true&asOnDate='+asOnDate+'&fromDate='+fromDate+'&department.id='+department+'&fund.id='+fund+
...
function exportPdf(){
	...
	if(document.getElementById('showRemittedEntries').checked)
		...
		showRemittedEntries = false;
	window.open('/services/EGF/report/pendingTDSReport-exportPdf.action?skipPrepare=true&asOnDate='+asOnDate+'&fromDate='+fromDate+'&department.id='+department+'&fund.id='+
