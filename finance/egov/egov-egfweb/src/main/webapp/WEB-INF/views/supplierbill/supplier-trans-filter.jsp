		...
		<c:when test="${headerFields.contains('fund')}">
			<c:choose>
				...
				<form:hidden path="" name="fundId" id="fundId" value="${egBillregister.egBillregistermis.fund.id }"/>
					<label class="col-sm-3 control-label text-right"><spring:message code="lbl.fund" />${egBillregister.egBillregistermis.scheme.id }
...
<div class="form-group">
	<c:choose>
		<c:when test="${headerFields.contains('scheme')}">
			<form:hidden path="" name="schemeId" id="schemeId" value="${egBillregister.egBillregistermis.schemeId }"/>
			<c:choose>
	...
	<c:choose>
		...
		<form:hidden path="" name="subSchemeId" id="subSchemeId" value="${egBillregister.egBillregistermis.subSchemeId }"/>
			<c:choose>
