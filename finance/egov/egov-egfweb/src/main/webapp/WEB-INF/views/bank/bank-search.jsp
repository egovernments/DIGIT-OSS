...
<form:form role="form" action="search" modelAttribute="bankSearchRequest" id="banksearchform" cssClass="form-horizontal form-groups-bordered" enctype="multipart/form-data">
	<div class="row">
		<div class="col-md-12">
