...
<div class="form-group">
	<label class="col-sm-2 control-label text-right" for="orderNumber"> <spring:message code="workorder.number" /><span class="mandatory"></span> 
	</label>
	...
	<label class="col-sm-2 control-label text-right" for="orderDate"> <spring:message code="workorder.date" /><span class="mandatory"></span>
	</label>
	<div class="col-sm-3 add-margin">
...
<div class="form-group">
	...
	<div class="col-sm-3 add-margin">
		<form:input path="name" id="name" maxlength="100" cssClass="form-control patternvalidation" data-pattern="alphabetWithSpecialCharForContraAndWorkOrder" required="required"/>
...
<div class="form-group">
	<label class="col-sm-2 control-label text-right" for="contractor"> <spring:message code="workorder.contractor" /><span class="mandatory"></span> 
	</label>
...
<div class="form-group">
	<label class="col-sm-2 control-label text-right" for="orderValue"> <spring:message code="workorder.ordervalue" /><span class="mandatory"></span> 
	</label>
	<div class="col-sm-3 add-margin">
	...
	<label class="col-sm-2 control-label text-right" for="advancePayable"> <spring:message code="workorder.advancepayable" />
	</label>
	<div class="col-sm-3 add-margin">
...
<div class="form-group">
	<label class="col-sm-2 control-label text-right" for="fund"> <spring:message code="workorder.fund" /><span class="mandatory"></span> 
	</label>
	<div class="col-sm-3 add-margin">
	...
	<label class="col-sm-2 control-label text-right" for="department"> <spring:message code="workorder.department" /><span class="mandatory"></span> 
	</label>
	<div class="col-sm-3 add-margin">
...
<div class="form-group">
	<label class="col-sm-2 control-label text-right" for="scheme"> <spring:message code="workorder.scheme" />
	</label>
	<div class="col-sm-3 add-margin">
	...
	<label class="col-sm-2 control-label text-right" for="subScheme"> <spring:message code="workorder.subscheme" />
	</label>
	<div class="col-sm-3 add-margin">
