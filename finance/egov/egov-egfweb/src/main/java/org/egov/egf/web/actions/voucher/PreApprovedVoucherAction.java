...
public class PreApprovedVoucherAction extends GenericWorkFlowAction {
	 ...
	 * (FinancialConstants.STANDARD_VOUCHER_TYPE_CONTRA.equals(parameters.get(
	 * "from")[0])) return null; else return null; }
	 */
	...
	public String loadvoucherviewByCGN() throws ApplicationException {
		 ...
		 * voucherDetailList = persistenceService.findAllBy(
		 ...
		 * ,voucherHeader.getId()); billDetails.put("voucherDetailList",
		 * voucherDetailList);
		 */
		getHeaderMandateFields();
		getMasterDataForBillVoucher();
	...
	public void validate() {
		...
		/*
		 * if(parameters.get("comments")[0]!=null &&
		 * parameters.get("comments")[0].length()>1024)
	...
	public void getMasterDataForBillVoucher() throws ApplicationException {
		...
		if (voucherHeader != null) {
			 ...
			 * List<VoucherDetail> voucherDetailList=new
			 * ArrayList<VoucherDetail>(); voucherDetailList =
