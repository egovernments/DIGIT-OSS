...
public class PersonalInformation implements java.io.Serializable, EntityType {
	...
	private transient ReligionMaster religionMstr;

	private LanguagesKnownMaster languagesKnownMstr;

	private transient RecruimentMaster modeOfRecruimentMstr;
	...
	private transient TypeOfRecruimentMaster recruitmentTypeMstr;
	...
	private Set<LangKnown> egpimsLangKnowns = new HashSet<>(0);// should we keep it now?
	private Set<org.egov.eis.entity.Assignment> egpimsAssignment = new HashSet<>(0);

	public Set<org.egov.eis.entity.Assignment> getEgpimsAssignment() {
		return egpimsAssignment;
	}

	public void setEgpimsAssignment(Set<org.egov.eis.entity.Assignment> egpimsAssignment) {
	...
	public void setLanguagesKnownMstr(LanguagesKnownMaster languagesKnownMstr) {
	...
	public void setRecruitmentTypeMstr(TypeOfRecruimentMaster recruitmentTypeMstr) {
