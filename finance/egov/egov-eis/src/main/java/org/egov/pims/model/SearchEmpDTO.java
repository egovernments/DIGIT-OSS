...
public class SearchEmpDTO implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7009145558885975746L;
	String code = null;
	String name = null;
	Integer iD = null;
	Integer desID = null;
	...
	public SearchEmpDTO(Integer desID, Integer depID, String code, String name, Integer iD)
	...
	public SearchEmpDTO(Integer desID, Integer depID, String code, String name, Integer iD, Integer prdiD)
	...
	public SearchEmpDTO(Integer desID, Integer depID, String code, String name, Integer iD, java.sql.Date fromDate,
