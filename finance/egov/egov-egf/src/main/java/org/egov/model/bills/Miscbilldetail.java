...
public class Miscbilldetail implements java.io.Serializable {
    ...
    public Miscbilldetail(final Long id, final BigDecimal amount, final BigDecimal passedamount, final String paidto,
            final String approvedby, final Date created) {
        this.id = id;
        this.passedamount = passedamount;
        this.paidto = paidto;
    }

    public Miscbilldetail(final Long id, final String billnumber, final Date billdate, final BigDecimal passedamount,
            final String paidto) {
        this.id = id;
