...
public class Supplierbilldetail implements java.io.Serializable {
	...
	public Supplierbilldetail(final Integer id, final CVoucherHeader voucherheader, final Relation relation,
			final BigDecimal billamount, final BigDecimal passedamount, final Integer worksdetailid) {
		this.id = id;
	...
	public Supplierbilldetail(final Integer id, final CVoucherHeader voucherheader, final Relation relation,
			final EgBillregister egBillregister, final Date billdate, final String billnumber,
			final BigDecimal otherrecoveries, final String mrnnumber, final Date mrndate, final BigDecimal billamount,
			final BigDecimal passedamount, final String approvedby, final BigDecimal payableaccount,
			final String narration, final Integer worksdetailid, final BigDecimal tdsamount, final Boolean tdspaidtoit,
			final BigDecimal paidamount, final BigDecimal advadjamt, final Boolean isreversed, final BigDecimal assetid,
			final BigDecimal capRev, final BigDecimal mrnid, final Date paybydate) {
		this.id = id;
		this.voucherheader = voucherheader;
		this.relation = relation;
