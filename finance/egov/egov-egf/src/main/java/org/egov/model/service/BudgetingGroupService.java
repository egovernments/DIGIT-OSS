...
public class BudgetingGroupService {
	...
	public String validate(final BudgetGroup budgetGroup) {
	...
	public List<BudgetGroup> search(final BudgetGroupSearchRequest budgetGroupSearchRequest) {
		if (budgetGroupSearchRequest.getName() != null)
			return budgetGroupRepository.findBudgetGroupByNameLike(budgetGroupSearchRequest.getName());
		else
