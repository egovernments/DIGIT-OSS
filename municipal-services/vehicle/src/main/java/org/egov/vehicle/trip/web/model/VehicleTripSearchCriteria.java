...
public class VehicleTripSearchCriteria {
	...
	public enum SortBy {
		applicationStatus, applicationiNo, vehicle, referenceNo, createdTime, tripStartTime, tripEndTime
	}
	...
	public boolean isEmpty() {
		return (this.tenantId == null && this.offset == null && this.limit == null
				...
				&& CollectionUtils.isEmpty(this.vehicleIds) && CollectionUtils.isEmpty(this.tripOwnerIds)
				&& CollectionUtils.isEmpty(this.ids) && CollectionUtils.isEmpty(this.driverIds)
				&& CollectionUtils.isEmpty(this.applicationNos));
	}
