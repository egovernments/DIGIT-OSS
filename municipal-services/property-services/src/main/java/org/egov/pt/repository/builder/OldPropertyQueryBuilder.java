...
public class OldPropertyQueryBuilder {
	...
	public String getPropertyLikeQuery(OldPropertyCriteria criteria, List<Object> preparedStmtList) {
	...
	private String addPaginationWrapper(String query, List<Object> preparedStmtList, OldPropertyCriteria criteria) {
	...
	public String getPropertySearchQuery(OldPropertyCriteria criteria, List<Object> preparedStmtList) {
