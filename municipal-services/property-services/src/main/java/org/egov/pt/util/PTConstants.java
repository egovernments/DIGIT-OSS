...
public class PTConstants {
    ...
    public static final String ALTERNATE_NOTIFICATION_PAYMENT_ONLINE = "PT_ALTERNATE_NOTIFICATION_PAYMENT_ONLINE";

    public static final String NOTIFICATION_PAYMENT_OFFLINE = "PT_NOTIFICATION_PAYMENT_OFFILE";
    
    public static final String ALTERNATE_NOTIFICATION_PAYMENT_OFFLINE = "PT_ALTERNATE_NOTIFICATION_PAYMENT_OFFILNE";

    public static final String NOTIFICATION_PAYMENT_FAIL = "PT_NOTIFICATION_PAYMENT_FAIL";
    
    public static final String ALTERNATE_NOTIFICATION_PAYMENT_FAIL = "PT_ALTERNATE_NOTIFICATION_PAYMENT_FAIL";

    public static final String NOTIFICATION_PAYMENT_PARTIAL_OFFLINE = "PT_NOTIFICATION_PAYMENT_PARTIAL_OFFLINE";
    
    public static final String ALTERNATE_NOTIFICATION_PAYMENT_PARTIAL_OFFLINE = "PT_ALTERNATE_NOTIFICATION_PAYMENT_PARTIAL_OFFILNE";

    public static final String NOTIFICATION_PAYMENT_PARTIAL_ONLINE = "PT_NOTIFICATION_PAYMENT_PARTIAL_ONLINE";
    
    public static final String ALTERNATE_NOTIFICATION_PAYMENT_PARTIAL_ONLINE = "PT_ALTERNATE_NOTIFICATION_PAYMENT_PARTIAL_ONILNE";
