...
public class V1ApiControllerTest {
    ...
    public void v1RegistrationCreatePostSuccess() throws Exception {
        mockMvc.perform(post("/voter-services/v1/registration/_create").contentType(MediaType
    ...
    public void v1RegistrationSearchPostSuccess() throws Exception {
        mockMvc.perform(post("/voter-services/v1/registration/_search").contentType(MediaType
        .APPLICATION_JSON_UTF8))
        .andExpect(status().isOk());
    }
    ...
    public void v1RegistrationUpdatePostSuccess() throws Exception {
        mockMvc.perform(post("/voter-services/v1/registration/_update").contentType(MediaType
        .APPLICATION_JSON_UTF8))
        .andExpect(status().isOk());
    }
