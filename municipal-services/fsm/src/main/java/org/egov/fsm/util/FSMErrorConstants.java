...
@Component
public class FSMErrorConstants {
	...
	public static final String RECEIPT_ERROR = "RECEIPT_ERROR";
	...
	public static final String FSM_UPDATE_ERROR_COMMENT_REQUIRED = "FSM_UPDATE_ERROR_COMMENT_REQUIRED";

	public static final String INVALID_REQUEST = "INVALID_REQUEST";

	public static final String INVALID_FILE = "INVALID_FILE";

	public static final String FSM_UNKNOWN_DATE = "FSM_UNKNOWN_DATE";

	public static final String FSM_UNKNOWN_TIME = "FSM_UNKNOWN_TIME";

	public static final String FSM_INVALID_ACTION = "FSM_INVALID_ACTION";
	
	public static final String INVALID_TENANT_ID_MDMS_KEY = "INVALID_TENANTID";

	public static final String INVALID_TENANT_ID_MDMS_MSG = "No data found for this tenentID";

	public static final String INVALID_CREATE = "INVALID_CREATE";

	public static final String IDGEN_ERROR = "IDGEN_ERROR";

	public static final String EG_FSM_WF_ERROR_KEY_NOT_FOUND = "EG FSM WF ERROR KEY NOT FOUND";
