...
public class SWConstants {
	...
	public static final List<String> NOTIFICATION_ENABLE_FOR_STATUS = Collections
			.unmodifiableList(Arrays.asList(INITIATE_INITIATED, REJECT_REJECTED,
					...
					SUBMIT_APPLICATION_PENDING_FOR_DOCUMENT_VERIFICATION,VERIFY_AND_FORWARD_PENDING_APPROVAL_FOR_DISCONNECTION,
					APPROVE_FOR_DISCONNECTION_PENDING_FOR_PAYMENT,APPROVE_FOR_DISCONNECTION_PENDING_FOR_DISCONNECTION_EXECUTION,PAY_PENDING_FOR_DISCONNECTION_EXECUTION,
