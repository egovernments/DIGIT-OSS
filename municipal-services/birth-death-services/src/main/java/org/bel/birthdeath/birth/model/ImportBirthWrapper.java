...
public class ImportBirthWrapper {
	...
	List<String> keyList = Arrays.asList(new String[] { 
			...
			BirthDeathConstants.PLACEOFBIRTH_LARGE,
			BirthDeathConstants.F_EDUCATION_LARGE,
			BirthDeathConstants.F_RELIGION_LARGE,
			BirthDeathConstants.F_PROFFESSION_LARGE,
			BirthDeathConstants.F_NATIONALITY_LARGE,
			BirthDeathConstants.M_EDUCATION_LARGE,
			BirthDeathConstants.M_RELIGION_LARGE,
			BirthDeathConstants.M_PROFFESSION_LARGE,
			BirthDeathConstants.M_NATIONALITY_LARGE,
