...
public class Boundary {
	 ...
	 **/
	//@Schema(accessMode = Schema.AccessMode.READ_ONLY, description = "materialized path of the boundary - this would be of the format tenantid.[code] from parentt till teh current boundary")
