...
public class DriverSearchCriteria {
	...
	private List<String> driverLicenseNumber;
	...
	public boolean isEmpty() {
		...
		return (this.tenantId == null && this.offset == null && this.limit == null && this.mobileNumber == null
				&& CollectionUtils.isEmpty(this.driverLicenseNumber) && this.ownerIds == null
	...
	public boolean tenantIdOnly() {
		...
		return (this.tenantId != null && this.mobileNumber == null && this.ownerIds == null
				&& CollectionUtils.isEmpty(this.driverLicenseNumber) && CollectionUtils.isEmpty(this.name)
				&& CollectionUtils.isEmpty(this.ids) && CollectionUtils.isEmpty(this.status));
	}
