...
public class MDMSValidator {
	...
	public Map<String, List<String>> getAttributeValues(Object mdmsData) {
		...
		final Map<String, List<String>> respMdmsMap = new HashMap<>();
		modulepaths.forEach(modulepath -> {
			try {
				respMdmsMap.putAll(JsonPath.read(mdmsData, modulepath));
			} catch (Exception e) {
	 ...
	 */
	public void validateAgencyType(VendorRequest vendorRequest) {
	 ...
	 * @throws CustomException
	 */
	public void validatePaymentPreference(VendorRequest vendorRequest) {
