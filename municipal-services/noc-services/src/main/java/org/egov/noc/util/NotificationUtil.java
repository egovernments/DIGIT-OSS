...
public class NotificationUtil {
     ...
     * 
     * @param message The message for the specific noc
     ...
     * 
     * @param tenantId tenantId of the NOC
     ...
     * 
     * @param noc The noc for which message is to be sent
