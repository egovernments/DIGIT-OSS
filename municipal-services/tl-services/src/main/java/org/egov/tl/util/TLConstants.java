...
public class TLConstants {
    ...
    public static final String NOTIFICATION_TL_EXPIRE_EMAIL = "tl.en.expire.email";

    public static final String NOTIFICATION_TL_EXPIRE_MSG = "tl.en.expire.msg";
    ...
    public static final List<String> NOTIFICATION_CODES = Collections.unmodifiableList(Arrays.asList(
            ...
            RENEWAL_NOTIFICATION_PENDINGAPPROVAL_EMAIL,RENEWAL_NOTIFICATION_REJECTED_EMAIL,NOTIFICATION_TL_EXPIRE_EMAIL,NOTIFICATION_TL_EXPIRE_MSG));
    ...
    public static final String PORTAL_URL = "{PORTAL_LINK}";
