        ...
        //Pdf header
        {
          columns: [
            ...
            },
            {
              ...
              width: '*',
              text: [{ text: `${ulbName}\n`, style: 'title' }, { text: `${translate('pgr.title.ClosureNote')}`, style: 'subTitle' }],
              margin: [0, 12, 0, 0],
              alignment: 'center',
            },
            {
          ...
          table: {
            ...
            body: [
              ...
              [
                ...
                { text: ':', alignment: 'left' },
                { text: `${grievance[0].serviceRequestId}`, alignment: 'left' },
              ],
            ],
          },
          layout: 'noBorders',
...
export default connect(mapStateToProps, mapDispatchToProps)(ClosureNote);
