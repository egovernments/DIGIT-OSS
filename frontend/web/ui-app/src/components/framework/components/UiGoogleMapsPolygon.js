...
class SimpleMap extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if(!this.props.select && nextProps.select){
      ...
      console.log(this.state.polygon);
      if(this._polygon){
         let path=this._polygon.getPath();
  ...
  handlePolygonMounted=this.handlePolygonMounted.bind(this);
  ...
  handlePlacesChanged() {
    ...
    let tempArray=[];
    // Add polygon for the place returned from search bar
...
export default class UigoogleMapsPolygon extends Component {
