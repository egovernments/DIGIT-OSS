var dat = {
  'lcms.search': {
    ...
    result: {
      ...
      actionItems: [
        {
          ...
          url: '/update/lcms/advpaymentresolve/',
        },
        {
          label: 'Make Payment',
          url: '/update/lcms/advmakepayment/',
        },
      ],
      header: [
        {
      ...
      rowClickUrlUpdate: '/update/lcms/advpaymentdetails/{code}',
      rowClickUrlView: '/view/lcms/advpaymentdetails/{code}',
    },
  },
  'lcms.create': {
    numCols: 4,
