      ...
      applicationSuccessCard: {
        ...
        children: {
          card: acknowledgementCard({
            ...
            body: {
              labelName:
                "A notification regarding payment failure has been sent to property owner at registered Mobile No.",
...
const screenConfig = {
  ...
  beforeInitScreen: (action, state, dispatch) => {  
    ...
    const paymentFor = getQueryArg(window.location.href, "paymentFor");
...
//egov-common/acknowledgement?status=failure&receiptNumber=PB-TL-2019-10-29-003220&paymentFor=PT-1909-208877&tenantId=pb.amritsar
//egov-common/acknowledgement?status=success&receiptNumber=PB-TL-2019-10-29-003220&paymentFor=PT-1909-208877&tenantId=pb.amritsar
