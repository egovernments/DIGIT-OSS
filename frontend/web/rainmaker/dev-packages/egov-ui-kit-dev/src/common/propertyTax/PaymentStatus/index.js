  ...
  return (
    <div>
      <div key={1} style={{ marginBottom: "50px" }} className=" col-md-12 col-lg-12">
        ...
        <AcknowledgementCard acknowledgeType='success' receiptHeader="PT_PMT_RCPT_NO" messageHeader='PT_PROPERTY_PAYMENT_SUCCESS' message={paymentMessage} receiptNo={ReceiptNo} />
      </div>
