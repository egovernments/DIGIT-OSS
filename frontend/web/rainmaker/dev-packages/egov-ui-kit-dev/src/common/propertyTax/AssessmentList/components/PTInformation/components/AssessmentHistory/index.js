        ...
        <div>
          ...
          <div className="col-sm-6 col-xs-12" style={{ marginBottom: 1, marginTop: 1 }}>
            <div className="assess-history" style={{ float: "right" }}>
              <Button
                label={
                  <Label buttonLabel={true} label="PT_RE_ASSESS" color="rgb(254, 122, 81)" fontSize="16px" height="40px" labelStyle={labelStyle} />
                }
                ...
                onClick={() => {
                  if (this.props.selPropertyDetails.status == "INWORKFLOW") {
                    ...
                    history &&
                      history.push(
                        `/property-tax/assessment-form?FY=${Assessment.financialYear}&assessmentId=${Assessment.assessmentNumber}&isAssesment=false&isReassesment=true&propertyId=${propertyId}&tenantId=${Assessment.tenantId}`
                      );
                  }
                  // lastElement.onClick();
                }}
