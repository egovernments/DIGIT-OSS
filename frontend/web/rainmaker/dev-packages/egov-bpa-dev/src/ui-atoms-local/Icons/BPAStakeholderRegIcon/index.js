...
import "../index.css";
class BPAStakeholderRegIcon extends React.Component {
  render() {
    const { classes } = this.props;
    return (
      <SvgIcon viewBox="0 0 24 24" color="primary" className="module-page-icon">
        <g
...
export default BPAStakeholderRegIcon;
