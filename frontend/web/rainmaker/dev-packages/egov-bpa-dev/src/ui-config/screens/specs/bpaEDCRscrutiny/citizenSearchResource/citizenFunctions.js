...
const response={
  edcrDetail: [
    {
        dxfFile: "https://egov-dcr-galaxy.egovernments.org/edcr/rest/dcr/downloadfile/f7d42293-ba4c-4561-ac1d-f859db16c7b4?tenantId=amritsar",
        updatedDxfFile: "https://egov-dcr-galaxy.egovernments.org/edcr/rest/dcr/downloadfile/9521de3c-5acc-4fb5-bbd1-877ff6d01574?tenantId=amritsar",
        planReport: "https://egov-dcr-galaxy.egovernments.org/edcr/rest/dcr/downloadfile/7412d60c-eaab-49b3-9e3c-6689a7fddd11?tenantId=amritsar",
...
export const fetchData = async (action, state, dispatch) => {
  // const response = await getSearchResultsfromEDCR();
