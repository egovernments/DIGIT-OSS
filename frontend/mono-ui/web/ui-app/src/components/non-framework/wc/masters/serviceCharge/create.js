...
class createFeeMatrix extends Component {
  ...
  displayUI(results) {
    ...
    if (self.props.match.params.id) {
      ...
      Api.commonApiPost(url, query, {}, false, specifications[`wc.update`].useTimestamp).then(
        function(res) {
  ...
  calculatechargeDetails = (isAdd = false) => {
    ...
    if (isAdd) {
      if (
        currentData.ServiceCharges[0].chargeDetails[currentData.ServiceCharges[0].chargeDetails.length - 1].uomTo &&
        currentData.ServiceCharges[0].chargeDetails[currentData.ServiceCharges[0].chargeDetails.length - 1].amountOrpercentage
      ) {
        if (
          Number(currentData.ServiceCharges[0].chargeDetails[currentData.ServiceCharges[0].chargeDetails.length - 1].uomTo) >
          Number(currentData.ServiceCharges[0].chargeDetails[currentData.ServiceCharges[0].chargeDetails.length - 1].uomFrom)
        ) {
          let chargeDetails = {
            uomFrom: currentData.ServiceCharges[0].chargeDetails[currentData.ServiceCharges[0].chargeDetails.length - 1].uomTo,
            uomTo: '',
            amountOrpercentage: '',
          ...
          self.props.handleChange(
            ...
            'ServiceCharges[0].chargeDetails[' + currentData.ServiceCharges[0].chargeDetails.length + ']'
          );
                ...
                >
                  ...
                  <tbody>
                    {formData &&
                      ...
                      formData.ServiceCharges[0].hasOwnProperty('chargeDetails') &&
                      formData.ServiceCharges[0].chargeDetails.map((item, index) => {
                        return (
                          <tr key={index}>
                            <td>{item.uomFrom}</td>
                            <td>
                              <TextField
                                value={getVal('ServiceCharges[0].chargeDetails[' + index + '].uomTo')}
                                errorText={fieldErrors['ServiceCharges[0].chargeDetails[' + index + '].uomTo']}
                                onChange={e =>
                                  handleChange(
                                    e,
                                    'ServiceCharges[0].chargeDetails[' + index + '].uomTo',
                                    true,
                                    '^[0-9]{1,10}?$',
                                    '',
                            ...
                            <td>
                              <TextField
                                value={getVal('ServiceCharges[0].chargeDetails[' + index + '].amountOrpercentage')}
                                errorText={fieldErrors['ServiceCharges[0].chargeDetails[' + index + '].amountOrpercentage']}
                                onChange={e =>
                                  handleChange(
                                    e,
                                    'ServiceCharges[0].chargeDetails[' + index + '].amountOrpercentage',
                                    true,
                                    '^[0-9]{1,10}(\\.[0-9]{0,2})?$',
                                    '',
                            ...
                            <td>
                              <FloatingActionButton disabled={index == 0 || formData.ServiceCharges[0].chargeDetails[index + 1]} mini={true}>
                                <ContentRemove
                                  disabled={index == 0 || formData.ServiceCharges[0].chargeDetails[index + 1]}
                                  onClick={() => {
