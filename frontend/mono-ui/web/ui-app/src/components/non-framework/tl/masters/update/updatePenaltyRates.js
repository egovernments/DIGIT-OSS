                  ...
                  <tr key={index}>
                    <td>
                      {index == 0 ? (
                        <TextField
                          ...
                          onChange={e => handleChange(e, 'penaltyRates[' + index + '].fromRange', true, '^[-0-9]{1,10}?$', '', 'Enter Numbers only')}
                        />
                      ) : (
                        item.fromRange
                      )}{' '}
                    ...
                    <td>
                      <TextField
                        ...
                        onChange={e => handleChange(e, 'penaltyRates[' + index + '].toRange', true, '^[-0-9]{1,10}?$', '', 'Enter Numbers only')}
                      />
                    </td>
                    <td>
                      <TextField
