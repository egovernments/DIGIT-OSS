var dat = {
  'lcms.search': {
    ...
    result: {
      ...
      actionItems: [
        {
          ...
          url: '/update/lcms/opinionassignadvocate/',
        },
        {
          label: 'Update Opinion',
          url: '/update/lcms/updateopinion/',
        },
      ],
      header: [
        {
      ...
      resultPath: 'opinions',
      rowClickUrlUpdate: '/update/lcms/opiniondetails/{code}',
      rowClickUrlView: '/view/lcms/opiniondetails/{code}',
    },
  },
  'lcms.create': {
    numCols: 4,
