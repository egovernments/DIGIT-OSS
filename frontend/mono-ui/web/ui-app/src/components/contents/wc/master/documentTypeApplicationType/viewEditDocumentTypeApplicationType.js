...
class searchCategoryType extends Component {
  ...
  search = e => {
    ...
    Api.commonApiPost('/wcms/masters/categorytype/_search/', searchSet, {}, false, true).then(
      function(response) {
        flag = 1;
        self.setState({
  ...
  render() {
    _this = this;
    let { categoryTypeSearchSet, handleAutoCompleteKeyUp, handleChange } = this.props;
