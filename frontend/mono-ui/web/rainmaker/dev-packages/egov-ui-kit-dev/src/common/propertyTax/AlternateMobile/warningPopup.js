  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <div style={{ padding: '10px' }}><span style={{ display: "flex", marginTop: "10px", marginBottom: '10px' }}>           <Label label="PT_ALT_INVALIDNO" labelStyle={{ color: 'rgba(0, 0, 0, 0.6)', fontSize: "14px" }}></Label>
