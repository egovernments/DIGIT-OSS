...
export const getFullDeathCertDetailsCard = (inJsonPath) => 
{
  return getCommonCard({ 
    ...
    editButton: {
      ...
      visible:ifUserRoleExists("DEATH_APPLICATION_EDITOR"),
      children: {
    ...
    placeInfo: getCommonGrayCard({
      ...
      placeOfDeath:getCommonContainer({
        firstName: getLabelWithValue(
          {
