      ...
      downloadMenu: {
        ...
        props: {
          data: {
            ...
            props: { variant: "outlined", style: { height: "60px", color: "rgb(44,51,125)", marginRight: 10 }, className: "tl-download-button" },
            menu: []
          }
        }
      },
      printMenu: {
        ...
        props: {
          data: {
            ...
            leftIcon: "print",
            rightIcon: "arrow_drop_down",
            props: { variant: "outlined", style: { height: "60px", color: "rgb(44,51,125)" }, className: "tl-download-button" },
            menu: []
          }
        }
      }
