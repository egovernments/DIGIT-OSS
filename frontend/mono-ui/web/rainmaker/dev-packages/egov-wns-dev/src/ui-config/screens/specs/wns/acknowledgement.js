        ...
        downloadMenu: {
          ...
          props: {
            data: {
              ...
              props: { variant: "outlined", style: { height: "60px", color: "rgb(44,51,125)", maxWidth: "95%", marginRight: "-15px" }, className: "tl-download-button" },
              menu: downloadMenu
            }
          }
        },
        printMenu: {
          ...
          props: {
            data: {
              ...
              leftIcon: "print",
              rightIcon: "arrow_drop_down",
              props: { variant: "outlined", style: { height: "60px", color: "rgb(44,51,125)", maxWidth: "85%" }, className: "tl-print-button" },
              menu: printMenu
            }
          }
        }
