    ...
    case "Paid":
      return (
        <div>
          ...
          <div className="assessment-displayInline" style={{ color: 'rgb(68,214,44)' }} onClick={() => downloadReceipt(tenantId, consumerCode,businessService)}>
    ...
    case "Saved Draft":
      return (
        <div>
          ...
          <div className="assessment-displayInline" style={{ paddingTop: "10px", color: 'rgb(68,214,44)' }} onClick={() => downloadReceipt(tenantId, consumerCode)}>
            {/* <Link to="home" style={{ color: 'rgb(68,214,44)' }}> */}
            <LabelContainer labelKey="WS_COMMON_BUTTON_DOWNLOAD_RECEIPT" />
            {/* </Link> */}
          </div>
        </div>
