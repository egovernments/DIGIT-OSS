    ...
    case "Paid":
      return (
        <div>
          ...
          <div className="assessment-displayInline" style={{ color: 'mediumpurple' }} onClick={() => downloadReceipt(tenantId, consumerCode,businessService)}>
    ...
    case "Saved Draft":
      return (
        <div>
          ...
          <div className="assessment-displayInline" style={{ paddingTop: "10px", color: 'mediumpurple' }} onClick={() => downloadReceipt(tenantId, consumerCode)}>
            {/* <Link to="home" style={{ color: 'mediumpurple' }}> */}
            <LabelContainer labelKey="WS_COMMON_BUTTON_DOWNLOAD_RECEIPT" />
            {/* </Link> */}
          </div>
        </div>
