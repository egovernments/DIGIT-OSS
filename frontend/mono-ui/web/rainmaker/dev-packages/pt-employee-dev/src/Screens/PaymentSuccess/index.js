  ...
  toggleYearDialogue = () => {
    this.setState({
      yearDialogue: {
        ...
        urlToAppend: `/property-tax/assessment-form?assessmentId=${this.props.match.params.assessmentId}&purpose=assess&propertyId=${this.props.match.params.propertyId}&tenantId=${this.props.match.params.tenantId}`
      }
    })
  }
