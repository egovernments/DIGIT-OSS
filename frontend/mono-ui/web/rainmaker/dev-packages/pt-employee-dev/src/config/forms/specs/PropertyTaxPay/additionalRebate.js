  ...
  fields: {
    ...
    adhocPenaltyReason: {
      ...
      dropDownData: [
        ...
        {
          label: <Label label="PT_MISCALCULATION_DUES" />,
          value: "Miscalculation of earlier assessment"
        },
        {
          label: <Label label="PT_ONE_TIME_PENALTY" />,
    ...
    adhocExemptionReason: {
      ...
      dropDownData: [
        {
          label: <Label label="PT_REBATE_OPTION1" />,
          value: "Advanced paid by citizen earlier"
        },
        {
          label: <Label label="PT_REBATE_OPTION2" />,
          value: "Rebate provided by commissioner/EO"
        },
        {
          label: <Label label="PT_REBATE_OPTION3" />,
