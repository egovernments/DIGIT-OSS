...
export const jsPdfGenerator = ({ logo, name, email, phoneNumber, details }) => {
  const doc = new jsPDF();
  const detailsKeys = Object.keys(details);
  const detailsValues = Object.values(details);

  doc.setFontSize(12);
  doc.addImage(logo, "png", 2, 2, 20, 20);
  doc.text(name, 24, 14);
  doc.text(email, 160, 10);
  doc.text(phoneNumber, 160, 16);

  detailsKeys.forEach((key, i) => {
    doc.text(key, 60, i * 10 + 50);
    doc.text(":", 90, i * 10 + 50);
  });

  detailsValues.forEach((value, i) => {
    doc.text(value, 110, i * 10 + 50);
  });
...
//       name: "Punjab Municipal",
//       email: "humanweb@gmail.com",
//       phoneNumber: "801-218-0121",
//       details: {
//         name: "Joe Doe",
//         city: "San Francisco",
//       },
