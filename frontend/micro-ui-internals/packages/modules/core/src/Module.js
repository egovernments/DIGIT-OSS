      ...
      <div className="ground-container">
        <div className="employeeCard">
          <div className="complaint-links-container">
            ...
            <div className="body">
              <span className="link"><Link to="/digit-ui/employee/pgr/inbox">Inbox</Link></span>
              <span className="link"><Link to="/digit-ui/employee/pgr/complaint/create">New Complaint</Link></span>
            </div>
          </div>
        </div>
      </div>
