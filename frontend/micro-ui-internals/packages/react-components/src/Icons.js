...
const ArrowLeft = ({ color = "black", large = false }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill={color} width={large ? "38px" : "19px"}>
...
export { ArrowLeft, ArrowDown, camera, deleteBtn, success, error, starfilled, starempty, searchicon, check };
