...
export const PaymentService = {
  ...
  recieptSearch: (tenantId, businessService, params) =>
    Request({
      url: businessService === "BPAREG"? Urls.payment.obps_Reciept_Search : Urls.payment.reciept_search,
      urlParams: businessService === "BPAREG"? {}:{ buisnessService: businessService },
      method: "POST",
