...
import { Link, useHistory, useParams, useLocation, useRouteMatch, Switch } from 'react-router-dom';
import { useTranslation } from 'react-i18next';
import { Table, Card, PersonIcon, CloseSvg, Label, TextInput, DatePicker, LinkLabel, SubmitBar, ActionBar, Loader, Dropdown, RemoveableTag, RadioButtons, ApplyFilterBar, DetailsCard, SearchAction, FilterAction, PopUp, Header, EmployeeModuleCard, FormComposer, Toast, LabelFieldPair, CardLabel, MultiSelectDropdown, CheckBox, CardLabelError, CardText, Banner, UploadFile, Modal, StatusTable, Row, CardSubHeader, DocumentSVG, Menu, PrivateRoute } from '@egovernments/digit-ui-react-components';
