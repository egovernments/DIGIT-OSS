...
import Filter from "./SurveyFilters";
...
const AllSurveys = ({ isLoading, data, t, title, iconName, links, onSearch, globalSearch, searchFields, searchParams, onFilterChange, pageSizeLimit, totalRecords }) => {
