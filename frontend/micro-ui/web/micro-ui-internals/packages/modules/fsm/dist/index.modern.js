import { ShippingTruck, EmployeeModuleCard, FormStep, RadioOrSelect, LabelFieldPair, CardLabel, Dropdown, Loader, LocationSearchCard, TextArea, CardLabelError, TextInput, CitizenInfoLabel, PitDimension, TelePhone, CardSectionHeader, CheckPoint, ConnectingCheckPoints, ActionLinks, Rating, SubmitBar, Header, MultiLink, Card, KeyNote, CardHeader, CardText, CardSubHeader, StatusTable, Row, LinkButton, Banner, RatingCard, Table, DatePicker, Modal, FormComposer, BreakLine, Toast, ActionBar, Menu, CheckBox, RadioButtons, CloseSvg, Localities, RemoveableTag, ApplyFilterBar, Label, LinkLabel, DetailsCard, SearchAction, FilterAction, PopUp, CitizenHomeCard, CitizenTruck, PrivateRoute, BackButton, BreadCrumb } from '@egovernments/digit-ui-react-components';
import React, { useState, useEffect, Fragment, useMemo, useCallback } from 'react';
import { useTranslation } from 'react-i18next';
import { useLocation, Link, useParams, useHistory, useRouteMatch, Switch, Route, Redirect } from 'react-router-dom';
...
var SelectTripData = function SelectTripData(_ref) {
  ...
  var _useState = useState(formData === null || formData === void 0 ? void 0 : (_formData$tripData = formData.tripData) === null || _formData$tripData === void 0 ? void 0 : _formData$tripData.vehicleType),
      vehicle = _useState[0],
...
var Response = function Response(_ref) {
  ...
  }), /*#__PURE__*/React.createElement(CardText, null, t("CS_FILE_PROPERTY_RESPONSE")), mutation.isSuccess && /*#__PURE__*/React.createElement(LinkButton, {
  ...
  return {
    ...
    form: [{
      body: [{
        ...
        isMandatory: true,
        type: "dropdown",
        populators: /*#__PURE__*/React.createElement(React.Fragment, null, getFilteredDsoData(dsoData, vehicle) && !getFilteredDsoData(dsoData, vehicle).length ? /*#__PURE__*/React.createElement(CardLabelError, null, t("ES_COMMON_NO_DSO_AVAILABLE_WITH_SUCH_VEHICLE")) : null, /*#__PURE__*/React.createElement(Dropdown, {
  ...
  return {
    ...
    form: [{
      body: [].concat(showReassignReason ? [{
        ...
        isMandatory: true,
        type: "dropdown",
        populators: /*#__PURE__*/React.createElement(React.Fragment, null, getFilteredDsoData$1(dsoData, vehicle) && !getFilteredDsoData$1(dsoData, vehicle).length ? /*#__PURE__*/React.createElement(CardLabelError, null, t("ES_COMMON_NO_DSO_AVAILABLE_WITH_SUCH_VEHICLE")) : null, /*#__PURE__*/React.createElement(Dropdown, {
...
var Status = function Status(_ref) {
  ...
  }) : null, mergedRoleDetails.fixed === false ? /*#__PURE__*/React.createElement("div", {
...
var Filter = function Filter(_ref) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, (!DSO && !isFstpOperator && searchParams || (mergedRoleDetails === null || mergedRoleDetails === void 0 ? void 0 : (_mergedRoleDetails$st = mergedRoleDetails.statuses) === null || _mergedRoleDetails$st === void 0 ? void 0 : _mergedRoleDetails$st.length) > 0) && /*#__PURE__*/React.createElement("div", {
    className: "filter",
    style: {
    ...
    tenantId: tenantId,
    t: t
  }), /*#__PURE__*/React.createElement("div", null)), (mergedRoleDetails === null || mergedRoleDetails === void 0 ? void 0 : (_mergedRoleDetails$st2 = mergedRoleDetails.statuses) === null || _mergedRoleDetails$st2 === void 0 ? void 0 : _mergedRoleDetails$st2.length) > 0 ? /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    className: "filter-label"
  ...
  }))) : null, /*#__PURE__*/React.createElement("div", null, isRoleStatusFetched && mergedRoleDetails ? /*#__PURE__*/React.createElement(Status, {
  ...
  }) : /*#__PURE__*/React.createElement(Loader, null)))), props.type === "mobile" && /*#__PURE__*/React.createElement(ActionBar, null, /*#__PURE__*/React.createElement(ApplyFilterBar, {
    submit: false,
...
var ApplicationLinks = function ApplicationLinks(_ref) {
  ...
  var GetLogo = function GetLogo() {
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "text"
    }, t("ES_TITLE_FAECAL_SLUDGE_MGMT")), /*#__PURE__*/React.createElement("span", {
      className: "logo"
    }, /*#__PURE__*/React.createElement(ShippingTruck, null)), " ");
  };
...
var MobileInbox = function MobileInbox(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "filters-container"
  }, !isFstpOperator && !isSearch && /*#__PURE__*/React.createElement(ApplicationLinks, {
...
var FstpOperatorDetails = function FstpOperatorDetails() {
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Card, null, /*#__PURE__*/React.createElement(StatusTable, null, vehicleData.map(function (row, index) {
    return /*#__PURE__*/React.createElement(Row, {
      key: row.title,
      label: row.title,
      text: row.value || "N/A",
  ...
  }), /*#__PURE__*/React.createElement(CardLabelError, null, t(errors.tripStartTime)), /*#__PURE__*/React.createElement("form", {
  ...
  }, t("ES_FSTP_OPERATOR_DETAILS_WASTE_GENERATORS")), isSearchLoading || isIdle ? /*#__PURE__*/React.createElement(Loader, null) : /*#__PURE__*/React.createElement(Card, null, /*#__PURE__*/React.createElement(StatusTable, null, tripDetails.map(function (trip, index) {
...
var Inbox = function Inbox(_ref) {
  ...
  if ((applications === null || applications === void 0 ? void 0 : (_applications$table = applications.table) === null || _applications$table === void 0 ? void 0 : _applications$table.length) !== null) {
    if (isMobile) {
      ...
      return /*#__PURE__*/React.createElement("div", null, !isSearch && /*#__PURE__*/React.createElement(Header, null, t("ES_COMMON_INBOX"), Number(applications === null || applications === void 0 ? void 0 : applications.totalCount) ? /*#__PURE__*/React.createElement("p", {
        className: "inbox-count"
      }, Number(applications === null || applications === void 0 ? void 0 : applications.totalCount)) : null), /*#__PURE__*/React.createElement(DesktopInbox, {
...
var Response$1 = function Response(props) {
  ...
  return /*#__PURE__*/React.createElement(Card, null, /*#__PURE__*/React.createElement(BannerPicker$1, {
  ...
  }), /*#__PURE__*/React.createElement(CardText, null, DisplayText(state.action, mutation.isSuccess, props.parentRoute.includes("employee"), t)), mutation.isSuccess && /*#__PURE__*/React.createElement(LinkButton, {
    label: /*#__PURE__*/React.createElement("div", {
      className: "response-download-button"
    }, /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement("svg", {
      xmlns: "http://www.w3.org/2000/svg",
    ...
    label: t("CORE_COMMON_GO_TO_HOME")
  })), props.parentRoute.includes("employee") && (state !== null && state !== void 0 && (_state$applicationDat = state.applicationData) !== null && _state$applicationDat !== void 0 && _state$applicationDat.applicationNo || mutation.isSuccess && mutation.data.fsm[0].applicationNo) && paymentAccess && mutation.isSuccess ? /*#__PURE__*/React.createElement("div", {
...
var EmployeeApp = function EmployeeApp(_ref2) {
  ...
  return /*#__PURE__*/React.createElement(Switch, null, /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement(FsmBreadCrumb, {
    location: location
    ...
    component: function component(props) {
      return /*#__PURE__*/React.createElement(Response$1, _extends({}, props, {
        parentRoute: path
      }));
    }
  }), /*#__PURE__*/React.createElement(PrivateRoute, {
    ...
    component: function component() {
      return /*#__PURE__*/React.createElement(MarkForDisposal, {
        parentRoute: path
      });
    }
  }))));
...
var CitizenApp = function CitizenApp(_ref3) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, !location.pathname.includes("/new-application/response") && /*#__PURE__*/React.createElement(BackButton, null, t("CS_COMMON_BACK")), /*#__PURE__*/React.createElement(Switch, null, /*#__PURE__*/React.createElement(PrivateRoute, {
    path: path + "/inbox",
    component: function component() {
    ...
    path: path + "/new-application",
    component: function component() {
      return /*#__PURE__*/React.createElement(FileComplaint, {
        parentRoute: path
      });
    }
  }), /*#__PURE__*/React.createElement(PrivateRoute, {
    ...
    path: path + "/response",
    component: function component(props) {
      return /*#__PURE__*/React.createElement(Response$1, _extends({
        parentRoute: path
      }, props));
    }
  }), /*#__PURE__*/React.createElement(PrivateRoute, {
