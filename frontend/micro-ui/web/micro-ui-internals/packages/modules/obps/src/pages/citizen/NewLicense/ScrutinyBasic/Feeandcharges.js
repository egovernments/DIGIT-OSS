          ...
          >
              ...
              <Col col-12>
                ...
                <div className="px-2">
                  ...
                  <ul className="Undertakings">
                    <li>
                      I, alongwith the expert team have gone through the applicable Acts/ Rules/ Policies/statutory provisions related to development
                      of colony and the application is being submitted after going through the same.
                    </li>
                    <li>I/We have not applied for any other licence/ CLU permission for this land anywhere else.</li>
                    <li>
                      I understand that execution of External Development Works involves long gestation period as the same are town level facilities
                      and I / we shall not, at any point of time, claim any damages against the Department for non completion of the external
                      development works.{" "}
                    </li>
                    <li>
            ...
            Text in a modal
                    ...
                    <ul>
                      ...
                      <li>
                        Phasellus ultrices nulla quis nibh. Quisque a lectus. Donec consectetuer ligula vulputate sem tristique cursus. Nam nulla
