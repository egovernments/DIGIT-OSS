              ...
              <input
                ...
                onChange={(e) => {
                  if (e?.target?.value > (watch("netPlannedArea") * 35) / 100) {
                    setError({ ...error, ["permissableGroundCoverage"]: "Ground Coverage cannot be more than 35% of NPA" });
              ...
              <input
                ...
                onChange={(e) => {
                  if (e?.target?.value > (watch("netPlannedArea") * 0.5) / 100) {
                    setError({ ...error, ["permissableCommercial"]: "Commercial(In acres) cannot be more than 0.5% of NPA" });
              ...
              <NumberInput
                ...
                onChange={(e) => {
                  if (e?.target?.value > (watch("netPlannedArea") * 1.75) / 100) {
                    setError({ ...error, ["permissableFAR"]: "Permissable FAR cannot be more than 1.75% of NPA" });
