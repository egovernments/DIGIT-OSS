...
const GIS = ({ t, config, onSelect, formData = {},handleRemove,onSave }) => {
  ...
  return (
    ...
    <LinkButton
            ...
            <div>
            <span>
            <svg style={{float:"left", position:"relative",bottom:"32px",marginTop:Webview?"62px":"57px",marginLeft:Webview?"23%":"20px",marginRight:"4px" }} width="24" height="24" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg style={{float:"right", position:"relative",bottom:"32px",marginTop:Webview?"70px":"60px",marginRight:Webview?"24%":"5px" }} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
           ...
           />
    <div style={Webview?{marginLeft:"22%", marginRight:"22%"}:{}}>
    <LocationSearchCard
