          ...
          <FormStep
            ...
            isDisabled={
              showDevTypeFields === "Individual" || showDevTypeFields === "Proprietorship Firm"
                ? !(name && mobileNumberUser?.match(Digit.Utils.getPattern("MobileNo")) && emailId?.match(Digit.Utils.getPattern("Email")))
                ...
                ? !cin_Number?.match(Digit.Utils.getPattern("CIN")) ||
                  ...
                  !(
                    ...
                    (existingColonizer === "Y" &&
                      ...
                      existingColonizerDetails.dob &&
                      existingColonizerDetails.pan &&
                      existingColonizerDetails.pan.match(Digit.Utils.getPattern("PAN")) &&
                      existingColonizerDetails.licNo &&
                      existingColonizerDetails.licDate &&
                      existingColonizerDetails.licValidity &&
                      existingColonizerDetails.licPurpose)
                  )
                : true
            }
            t={t}
                    ...
                    <div className="col-sm-12">
                      <div className="form-group row">
                        <div className="col-sm-4">
                          <CardLabel class="required">
                            {`${t("Select Developer's Type")}`}
                    ...
                    <div className="card-body">
                      <div className="row">
                        ...
                        <div className="col col-4">
                          <div className="form-group">
                            <label htmlFor="name">
                              Company Name <span className="text-danger font-weight-bold">*</span>
                            </label>
                      ...
                      /> */}
                        ...
                        <div className="col col-4">
                          <div className="form-group">
                            <label htmlFor="name">
                              GST No. <span className="text-danger font-weight-bold">*</span>
                            </label>
                            <TextInput
                              type="text"
                              value={gst_Number}
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          {existingColonizerDetails.aggreementBtw ? (
                                            <button
                                              type="button"
                                              onClick={() => getDocShareholding(existingColonizerDetails.aggreementBtw)}
                                              className="btn btn-sm col-md-6"
                                            >
                                              <VisibilityIcon color="info" className="icon" />
                                            </button>
                          ...
                          />
                            ...
                            <div className="col col-4">
                              <div className="form-group">
                                ...
                                />
                                {existingColonizerDetails.pan &&
                                  existingColonizerDetails.pan.length > 0 &&
                                  !existingColonizerDetails.pan.match(Digit.Utils.getPattern("PAN")) && (
                                    <CardLabelError
                                      style={{ width: "100%", marginTop: "-15px", fontSize: "16px", marginBottom: "12px", color: "red" }}
                                    >
