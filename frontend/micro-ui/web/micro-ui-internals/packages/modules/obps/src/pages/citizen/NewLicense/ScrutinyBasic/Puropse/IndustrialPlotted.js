            ...
            <div className="table table-bordered table-responsive">
              ...
              <tbody>
                <tr>
                  ...
                  <td align="right">  <input type="number" className="form-control" disabled placeholder={industrialData?.upTo50?.plotNo} /></td>
                ...
                <tr>
                  ...
                  <td align="right">  <input type="number" className="form-control" disabled placeholder={industrialData?.upTo200?.plotNo} /></td>
                  <td component="th" scope="row">
                ...
                <tr>
                  ...
                  <td align="right">  <input type="number" className="form-control" disabled placeholder={industrialData?.moreThan200?.plotNo} /></td>
                  <td component="th" scope="row">
                ...
                <tr>
                  ...
                  <td align="right">  <input type="number" className="form-control" disabled placeholder={industrialData?.residentialDDJAY?.plotNo} /></td>
                  <td component="th" scope="row">
                ...
                <tr>
                  ...
                  <td align="right">  <input type="number" className="form-control" disabled placeholder={industrialData?.facilitiesDDJAY?.plotNo} /></td>
                  <td component="th" scope="row">
                ...
                <tr>
                  ...
                  <td align="right">  <input type="number" className="form-control" disabled placeholder={industrialData?.affordableHousing?.plotNo} /></td>
                  <td component="th" scope="row">
