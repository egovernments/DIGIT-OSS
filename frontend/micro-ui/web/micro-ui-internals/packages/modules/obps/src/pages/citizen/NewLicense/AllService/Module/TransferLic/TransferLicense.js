...
const Transferlicence = () => {
  ...
  const transferLic = async (data) => {
    ...
    try {
      ...
      const Resp = await axios.post("/tl-services/TransferOflicenceRequest/_create", postDistrict);
                        ...
                        <tbody>
                          ...
                          {(watch("selectType")?.value == "partial" || watch("selectType")?.value == "complete") && (
                            <tr>
                              ...
                              <td>
                                The colonizer seeking transfer of whole licence/part licence shall submit self-certification along with a certificate
                                of the Chartered Accountant that a 15% profit margin is not exceeded from the project cost at the time of submission
                                of application for transfer of licence <span style={{ color: "red" }}>*</span>
                              </td>
                              <td>
                                <div>
                                  <label>
                          ...
                          {(watch("selectType")?.value == "partial" ||
                            ...
                            <tr>
                              ...
                              <td>
                                ...
                                for the purpose; as well as from the ‘land owner licencees’, in person (not through GPA/SPA assignees), to the
