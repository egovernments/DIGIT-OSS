...
const DeveloperCapacity = ({ t, config, onSelect, value, userType, formData }) => {
  ...
  const handleArrayValues = () => {
    if (
      ...
      purposeOfColony &&
      hrduModalData.technicalExpertEngaged
    ) {
      const values = {
        ...
        <FormStep
          ...
          isDisabled={
            ...
            townPlannerQualification
              ? false
              : true ||
                (!Documents?.engineerSign && !Documents?.architectSign && !Documents?.townPlannerSign ? true : false) ||
                (technicalExpert === "N" ? false : true))
          }
        >
          {/* <CheckBox
                        ...
                        <td align="center" size="large">
                          <div className="row">
                            ...
                            <div className="btn btn-sm col-md-6">
                              <label for="individualCertificateCA">
                                {" "}
                  ...
                  <table className="table table-bordered" size="sm">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td> 4 </td>
                        <td>
                          Any other documents (in the case of the company) <span className="text-danger font-weight-bold">*</span>
                        </td>
                        {/* <td>
                                                    <input
                                                        type="file"
          ...
          <div className="card-body">
                                ...
                                <td>
                                  <div className="row">
                                    {elementInArray.engineerDegree ? (
                                      <a onClick={() => getDocShareholding(elementInArray.engineerDegree)} className="btn btn-sm col-md-6">
                                        <VisibilityIcon color="info" className="icon" />
                                      </a>
                                    ) : (
                                      <p></p>
                                ...
                                <td>
                                  <div className="row">
                                    {elementInArray.architectDegree ? (
                                      <a onClick={() => getDocShareholding(elementInArray.architectDegree)} className="btn btn-sm col-md-6">
                                        <VisibilityIcon color="info" className="icon" />
                                      </a>
                                    ) : (
                                      <p></p>
                                ...
                                <td>
                                  <div className="row">
                                    {elementInArray.townPlannerDegree ? (
                                      <a onClick={() => getDocShareholding(elementInArray.townPlannerDegree)} className="btn btn-sm col-md-6">
                                        <VisibilityIcon color="info" className="icon" />
                                      </a>
                                    ) : (
                                      <p></p>
            ...
            {permissionGrantedHRDU === "N" && (
              <div>
                {(data?.devDetail[0]?.addInfo?.showDevTypeFields === "Individual" ||
                  data?.devDetail[0]?.addInfo?.showDevTypeFields === "Proprietorship Firm") && (
                  <p>
                    (ii) Whether you hold designation of director/partner in any other company/firm who has already obtained license(s) under act of
                    1975: <span className="text-danger font-weight-bold">*</span>
                  </p>
                )}
                {(data?.devDetail[0]?.addInfo?.showDevTypeFields === "Company" ||
                  data?.devDetail[0]?.addInfo?.showDevTypeFields === "Society" ||
                  ...
                  data?.devDetail[0]?.addInfo?.showDevTypeFields === "Partnership Firm") && (
                  <p>
                    (ii) If director/partner of the proposed developer company/firm also holds designation of director/partner in any other
                    company/firm who has already obtained license(s) under act of 1975: <span className="text-danger font-weight-bold">*</span>
                  </p>
                )}
            ...
            {(data?.devDetail[0]?.addInfo?.showDevTypeFields === "Individual" ||
              data?.devDetail[0]?.addInfo?.showDevTypeFields === "Proprietorship Firm") && (
              <p>
                (iii) Have you developed project in case of technical capacity of company/firm developed projects outside Haryana:-{" "}
                <span className="text-danger font-weight-bold">*</span>
              </p>
            )}
            {(data?.devDetail[0]?.addInfo?.showDevTypeFields === "Company" ||
            ...
            <div className="form-group">
              ...
              {technicalCapacityOutsideHaryana === "Y" && (
                <Row>
                  <Col md={4} xxl lg="4">
                    <label htmlFor="project" className="text">
                      {" "}
                      Project <span className="text-danger font-weight-bold">*</span>
                    </label>
                    <input
                      type="text"
                      name="project"
                  ...
                  <Col md={4} xxl lg="4">
                    <label htmlFor="authority" className="text">
                      {" "}
                      Authority <span className="text-danger font-weight-bold">*</span>
                    </label>
                    <input
                      type="text"
                      name="authority"
                  ...
                  <Col md={4} xxl lg="4">
                    <label htmlFor="statusOfDevelopment" className="text">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setTechnicalCapacityOutsideHaryanaDetails({ ...technicalCapacityOutsideHaryanaDetails, statusOfDevelopment: e.target.value })
                      }
                      placeholder=""
                      class="employee-card-input"
                    />
            ...
            {(data?.devDetail[0]?.addInfo?.showDevTypeFields === "Company" ||
              ...
              <div>
                <p>
                  (iv). In case of technical capacity sought from another company/firm who has already obtained license(s) under act of 1975 or
                  outside Haryana:<span className="text-danger font-weight-bold">*</span>
                </p>
                        ...
                        <div className="col col-4">
                          <div className="form-group">
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                setTechnicalCapacitySoughtFromAnyColonizer({ ...technicalCapacitySoughtFromAnyColonizer, licNo: e.target.value })
                              }
                        ...
                        <div className="col col-4">
                          <div className="form-group">
                            ...
                            <input
                              ...
                              className="employee-card-input"
                              min={convertEpochToDate(
                                new Date().setFullYear(new Date().getFullYear() - technicalCapacitySoughtFromAnyColonizer.dateOfGrantingLic)
                              )}
                            />
                          </div>
                        </div>
                        ...
                        <div className="col col-4">
                          <div className="form-group">
                            ...
                            <Select
                              ...
                              onChange={(e) =>
                                setTechnicalCapacitySoughtFromAnyColonizer({ ...technicalCapacitySoughtFromAnyColonizer, purpose: e.target.value })
                              }
                              className="w-100"
                              variant="standard"
            ...
            {(data?.devDetail[0]?.addInfo?.showDevTypeFields === "Company" ||
              ...
              data?.devDetail[0]?.addInfo?.showDevTypeFields === "Partnership Firm") && (
              <p>
                (v) Whether any technical expert(s) engaged <span className="text-danger font-weight-bold">*</span>
              </p>
            )}
