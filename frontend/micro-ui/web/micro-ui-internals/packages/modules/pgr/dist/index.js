...
var SelectRating = function SelectRating(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(digitUiReactComponents.RatingCard, _extends({
    config: config
  }, {
    t: t,
    onSelect: log
...
var PendingAtLME = function PendingAtLME(_ref) {
  ...
  return name && mobile ? /*#__PURE__*/React__default.createElement(digitUiReactComponents.CheckPoint, {
    isCompleted: isCompleted,
    customChild: /*#__PURE__*/React__default.createElement(digitUiReactComponents.TelePhone, {
      mobile: mobile,
      text: text + " " + name
    })
...
var Resolved = function Resolved(_ref) {
  ...
  if (action === "RESOLVE") {
    ...
    return /*#__PURE__*/React__default.createElement(digitUiReactComponents.CheckPoint, {
      isCompleted: isCompleted,
      label: t("CS_COMMON_COMPLAINT_RESOLVED"),
      customChild: /*#__PURE__*/React__default.createElement(StarRated, {
...
var TimeLine = function TimeLine(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(digitUiReactComponents.CardSubHeader, null, t(LOCALIZATION_KEY.CS_COMPLAINT_DETAILS + "_COMPLAINT_TIMELINE")), timeline && timeline.length > 0 ? /*#__PURE__*/React__default.createElement(digitUiReactComponents.ConnectingCheckPoints, null, timeline.map(function (_ref4, index, array) {
...
var ComplaintDetailsPage = function ComplaintDetailsPage(props) {
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(digitUiReactComponents.Header, null, t(LOCALIZATION_KEY.CS_HEADER + "_COMPLAINT_SUMMARY")), Object.keys(complaintDetails).length > 0 ? /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(digitUiReactComponents.Card, null, /*#__PURE__*/React__default.createElement(digitUiReactComponents.CardSubHeader, null, t("SERVICEDEFS." + complaintDetails.audit.serviceCode.toUpperCase())), /*#__PURE__*/React__default.createElement(digitUiReactComponents.StatusTable, null, Object.keys(complaintDetails.details).map(function (flag, index, arr) {
  ...
  })), complaintDetails.thumbnails && complaintDetails.thumbnails.length !== 0 ? /*#__PURE__*/React__default.createElement(digitUiReactComponents.DisplayPhotos, {
    ...
    complaintDetails: complaintDetails,
    id: id
  })), /*#__PURE__*/React__default.createElement(digitUiReactComponents.Card, null, /*#__PURE__*/React__default.createElement(digitUiReactComponents.CardSubHeader, null, t(LOCALIZATION_KEY.CS_COMMON + "_COMMENTS")), /*#__PURE__*/React__default.createElement(digitUiReactComponents.TextArea, {
    value: comment,
...
var TLCaption = function TLCaption(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement("div", null, data.date && /*#__PURE__*/React__default.createElement("p", null, data.date), /*#__PURE__*/React__default.createElement("p", null, data.name), /*#__PURE__*/React__default.createElement("p", null, data.mobileNumber), data.source && /*#__PURE__*/React__default.createElement("p", null, t("ES_COMMON_FILED_VIA_" + data.source.toUpperCase())));
};
...
var ComplaintDetails = function ComplaintDetails(props) {
  ...
  var getTimelineCaptions = function getTimelineCaptions(checkpoint) {
    ...
    return checkpoint.caption && checkpoint.caption.length !== 0 ? /*#__PURE__*/React__default.createElement(TLCaption, {
  ...
  }),  null ), complaintDetails !== null && complaintDetails !== void 0 && complaintDetails.thumbnails && (complaintDetails === null || complaintDetails === void 0 ? void 0 : (_complaintDetails$thu = complaintDetails.thumbnails) === null || _complaintDetails$thu === void 0 ? void 0 : _complaintDetails$thu.length) !== 0 ? /*#__PURE__*/React__default.createElement(digitUiReactComponents.DisplayPhotos, {
...
var Complaint$1 = function Complaint() {
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement("div", {
    ...
    path: match.url + Employee.CreateComplaint,
    component: function component() {
      return /*#__PURE__*/React__default.createElement(CreateComplaint$1, {
        parentUrl: match.url
      });
    }
  }), /*#__PURE__*/React__default.createElement(reactRouterDom.Route, {
