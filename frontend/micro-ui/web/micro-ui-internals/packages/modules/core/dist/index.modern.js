...
import { FormStep, OTPInput, CardText, CardLabelError, AppContainer, BackButton, Toast, Dropdown, Loader, FormComposer, CardSubHeader, Card, CustomButton, SubmitBar, TopBar as TopBar$1, Hamburger, HomeIcon, LanguageIcon, LogoutIcon, NavBar, ComplaintIcon, PTIcon, CaseIcon, DropIcon, Calender, DocumentIcon, HelpIcon, StandaloneSearchBar, CardBasedOptions, WhatsNewCard, PageBasedInput, CardHeader, RadioButtons, Body } from '@egovernments/digit-ui-react-components';
...
var Header = function Header() {
  ...
  }), /*#__PURE__*/React.createElement("p", null, stateInfo === null || stateInfo === void 0 ? void 0 : stateInfo.name));
};
...
var Login$1 = function Login(_ref) {
  ...
  return isLoading || isStoreLoading ? /*#__PURE__*/React.createElement(Loader, null) : /*#__PURE__*/React.createElement(Background, null, /*#__PURE__*/React.createElement(FormComposer, {
    onSubmit: onLogin,
    noBoxShadow: true,
    inline: true,
    submitInForm: true,
...
var EmployeeLogin = function EmployeeLogin() {
  ...
  var loginParams = useMemo(function () {
...
var ChangePasswordComponent = function ChangePasswordComponent(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Background, null, /*#__PURE__*/React.createElement(FormComposer, {
  ...
  }, " ", propsConfig.texts.header, " "), /*#__PURE__*/React.createElement(CardText, null, t("CS_LOGIN_OTP_TEXT") + " " + mobileNumber), /*#__PURE__*/React.createElement(SelectOtp, {
    t: t,
    userType: "employee",
    otp: otp,
    onOtpChange: setOtp,
...
var LanguageSelection = function LanguageSelection() {
  ...
  return /*#__PURE__*/React.createElement(Background, null, /*#__PURE__*/React.createElement(Card, {
    ...
    className: "bannerLogo",
    src: stateInfo === null || stateInfo === void 0 ? void 0 : stateInfo.logoUrl
  }), /*#__PURE__*/React.createElement("p", null, stateInfo === null || stateInfo === void 0 ? void 0 : stateInfo.name)), /*#__PURE__*/React.createElement("div", {
...
var EmployeeApp = function EmployeeApp(_ref) {
  ...
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(AppModules, {
    stateCode: stateCode,
    userType: "employee",
    modules: modules,
...
var Home = function Home() {
  ...
  }, /*#__PURE__*/React.createElement(CardBasedOptions, allCitizenServicesProps), /*#__PURE__*/React.createElement(CardBasedOptions, allInfoAndUpdatesProps)), EventsDataLoading ? /*#__PURE__*/React.createElement(Loader, null) : /*#__PURE__*/React.createElement("div", {
    className: "WhatsNewSection"
  }, /*#__PURE__*/React.createElement("div", {
    className: "headSection"
  }, /*#__PURE__*/React.createElement("h2", null, t("DASHBOARD_WHATS_NEW_LABEL")), /*#__PURE__*/React.createElement("p", null, t("DASHBOARD_VIEW_ALL_LABEL"))), /*#__PURE__*/React.createElement(WhatsNewCard, EventsData === null || EventsData === void 0 ? void 0 : EventsData[0])));
};
...
var LocationSelection = function LocationSelection() {
  ...
  return isLoading ? /*#__PURE__*/React.createElement("loader", null) : /*#__PURE__*/React.createElement(PageBasedInput, {
    ...
    optionKey: "i18nKey",
    t: t
  }), /*#__PURE__*/React.createElement(RadioButtons, RadioButtonProps));
};
...
var Home$1 = function Home$1(_ref) {
  ...
  })), appRoutes)), /*#__PURE__*/React.createElement("div", {
