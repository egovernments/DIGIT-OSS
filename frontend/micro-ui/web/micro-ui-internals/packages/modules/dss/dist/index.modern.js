import React, { useContext, Fragment, useState, useRef, useEffect, useMemo, useCallback } from 'react';
import { useTranslation } from 'react-i18next';
import { Calender, CloseSvg, FilterIcon, RefreshIcon, MultiSelectDropdown, Loader, Rating, RemoveableTag, Table, UpwardArrow, DownwardArrow, DownloadIcon, EmailIcon, WhatsappIcon, Card, CardLabel, TextInput, EllipsisMenu, CardCaption, SearchIconSvg, Poll, Details, PrintIcon, Header, MultiLink, ShareIcon, PrivateRoute, BreadCrumb } from '@egovernments/digit-ui-react-components';
import { createStaticRanges, DateRangePicker } from 'react-date-range';
import { ResponsiveContainer, AreaChart, CartesianGrid, Tooltip, XAxis, YAxis, Area, BarChart, Bar, Legend, PieChart, Pie, Cell } from 'recharts';
import { useHistory, Link, useParams, useRouteMatch, useLocation, Switch as Switch$1 } from 'react-router-dom';
...
var Switch = function Switch(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement("div", null, t("ES_DSS_DENOMINATION")), /*#__PURE__*/React.createElement("div", {
...
var DateRange = function DateRange(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement("div", null, t("ES_DSS_DATE_RANGE")), /*#__PURE__*/React.createElement("div", {
...
var Filters = function Filters(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement(CloseSvg, null)), isOpen && /*#__PURE__*/React.createElement("div", {
    className: "filter-header"
  }, /*#__PURE__*/React.createElement(FilterIcon, null), /*#__PURE__*/React.createElement("p", null, t("DSS_FILTERS")), /*#__PURE__*/React.createElement("span", {
    onClick: handleClear
  }, /*#__PURE__*/React.createElement(RefreshIcon, null))), showDateRange && /*#__PURE__*/React.createElement("div", {
    className: "filters-input"
  }, /*#__PURE__*/React.createElement(DateRange, {
    onFilterChange: handleFilterChange,
    values: value === null || value === void 0 ? void 0 : value.range,
    t: t
  })), showDDR && /*#__PURE__*/React.createElement("div", {
    className: "filters-input"
  }, /*#__PURE__*/React.createElement("div", null, t("ES_DSS_DDR")), /*#__PURE__*/React.createElement(MultiSelectDropdown, {
  ...
  })), showUlb && /*#__PURE__*/React.createElement("div", {
    className: "filters-input"
  }, /*#__PURE__*/React.createElement("div", null, t("ES_DSS_ULB")), /*#__PURE__*/React.createElement(MultiSelectDropdown, {
    ...
    defaultUnit: t("ES_DSS_DDR_SELECTED")
  })), showDenomination && /*#__PURE__*/React.createElement("div", {
    className: "filters-input",
    style: {
      flexBasis: "16%"
    }
...
var CustomAreaChart = function CustomAreaChart(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, id === "fsmCapacityUtilization" && /*#__PURE__*/React.createElement("p", null, t("DSS_FSM_TOTAL_SLUDGE_TREATED"), " - ", totalWaste, " ", t("DSS_KL")), /*#__PURE__*/React.createElement(ResponsiveContainer, {
    width: "99%",
    height: id === "fsmTotalCumulativeCollection" ? 400 : 300
  }, !chartData || (chartData === null || chartData === void 0 ? void 0 : chartData.length) === 0 ? /*#__PURE__*/React.createElement("div", {
    className: "no-data"
  }, /*#__PURE__*/React.createElement("p", null, t("DSS_NO_DATA"))) : /*#__PURE__*/React.createElement(AreaChart, {
    width: "100%",
    height: "100%",
    data: chartData,
    margin: {
    ...
    stopColor: "#048BD0",
    stopOpacity: 0
  }))), /*#__PURE__*/React.createElement(CartesianGrid, null), /*#__PURE__*/React.createElement(Tooltip, {
...
var CustomBarChart = function CustomBarChart(_ref2) {
  ...
  if ((chartData === null || chartData === void 0 ? void 0 : chartData.length) === 0) {
    return /*#__PURE__*/React.createElement("div", {
      className: "no-data"
    }, /*#__PURE__*/React.createElement("p", null, t("DSS_NO_DATA")));
  }

  return /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement(ResponsiveContainer, {
    width: "99%",
    height: 320
    ...
    barGap: 70
  }, showGrid && /*#__PURE__*/React.createElement(CartesianGrid, null), /*#__PURE__*/React.createElement(XAxis, {
    hide: hideAxis,
    dataKey: xDataKey,
    type: xAxisType,
    domain: [0, 100]
    ...
    radius: [10, 10, 10, 10]
  }))), showDrillDown && /*#__PURE__*/React.createElement("p", {
    className: "showMore",
...
var CustomHorizontalBarChart = function CustomHorizontalBarChart(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement(ResponsiveContainer, {
    width: "99%",
    height: 300
  }, (chartData === null || chartData === void 0 ? void 0 : chartData.length) === 0 ? /*#__PURE__*/React.createElement("div", {
    className: "no-data"
  }, /*#__PURE__*/React.createElement("p", null, t("DSS_NO_DATA"))) : /*#__PURE__*/React.createElement(BarChart, {
    width: "100%",
    height: "100%",
    layout: layout,
    data: chartData,
    barGap: 14,
    barSize: 15
  }, /*#__PURE__*/React.createElement(CartesianGrid, null), /*#__PURE__*/React.createElement(YAxis, {
    dataKey: yDataKey,
    type: yAxisType,
    tick: {
      fontSize: "14px",
...
var InsightView = function InsightView(_ref) {
  ...
  return /*#__PURE__*/React.createElement("span", null, rowValue, " ", insight >= 0 ? /*#__PURE__*/React.createElement(UpwardArrow, null) : /*#__PURE__*/React.createElement(DownwardArrow, null), " ", Math.abs(insight) + "%");
};
...
var CustomTable = function CustomTable(_ref2) {
      ...
      return {
        ...
        Cell: function Cell(args) {
          ...
          if (typeof cellValue === "object") {
            return /*#__PURE__*/React.createElement(InsightView, {
              insight: cellValue === null || cellValue === void 0 ? void 0 : cellValue.insight,
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, filterStack.length > 1 && /*#__PURE__*/React.createElement("div", {
    ...
    return id > 0 ? /*#__PURE__*/React.createElement(RemoveableTag, {
      key: id,
...
var SearchImg = function SearchImg() {
  return /*#__PURE__*/React.createElement(SearchIconSvg, {
...
var GenericChart = function GenericChart(_ref) {
  ...
  var menuItems = [{
    ...
    i18nKey: t("ES_DSS_SHARE_IMAGE"),
    target: "whatsapp",
    icon: /*#__PURE__*/React.createElement(WhatsappIcon, null)
  }];
  ...
  }, /*#__PURE__*/React.createElement("div", null, showHeader && /*#__PURE__*/React.createElement(CardLabel, {
    style: {
      fontWeight: "bold"
    }
  }, "" + t(header)), subHeader && /*#__PURE__*/React.createElement("p", {
    style: {
      color: "#505A5F",
      fontWeight: 700
    }
  ...
  }, showSearch && /*#__PURE__*/React.createElement(TextInput, {
    className: "searchInput",
    placeholder: "Search",
    signature: true,
    signatureImg: /*#__PURE__*/React.createElement(SearchImg, null),
    onChange: onChange
  }), showDownload && /*#__PURE__*/React.createElement(DownloadIcon, {
  ...
  }))), caption && /*#__PURE__*/React.createElement(CardCaption, null, caption), React.cloneElement(children, {
...
var MetricData = function MetricData(_ref) {
  ...
  }, code === "citizenAvgRating" ? /*#__PURE__*/React.createElement(Rating, {
  ...
  }) : Digit.Utils.dss.formatter(data === null || data === void 0 ? void 0 : data.headerValue, data === null || data === void 0 ? void 0 : data.headerSymbol, value === null || value === void 0 ? void 0 : value.denomination, true) + " " + (code === "totalSludgeTreated" ? t("DSS_KL") : "")), (data === null || data === void 0 ? void 0 : data.insight) && /*#__PURE__*/React.createElement("div", null, (data === null || data === void 0 ? void 0 : (_data$insight = data.insight) === null || _data$insight === void 0 ? void 0 : _data$insight.indicator) === "upper_green" ? /*#__PURE__*/React.createElement(UpwardArrow, {
    marginRight: 9
  }) : /*#__PURE__*/React.createElement(DownwardArrow, {
    marginRight: 9
  }), /*#__PURE__*/React.createElement("p", {
...
var MetricChartRow = function MetricChartRow(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "row"
  }, /*#__PURE__*/React.createElement("div", null, t(data.name)), /*#__PURE__*/React.createElement(MetricData, {
    t: t,
...
var MetricChart = function MetricChart(_ref3) {
  ...
  return /*#__PURE__*/React.createElement(Fragment, null, charts.map(function (chart, index) {
    return /*#__PURE__*/React.createElement(MetricChartRow, {
      data: chart,
      key: index
    });
  }));
...
var Summary = function Summary(_ref2) {
  ...
  }, /*#__PURE__*/React.createElement(Poll, null), /*#__PURE__*/React.createElement("div", {
    className: "wrapper-child"
  }, /*#__PURE__*/React.createElement("div", {
    className: "blocks"
  }, /*#__PURE__*/React.createElement("p", null, t(data === null || data === void 0 ? void 0 : data.name))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex"
    }
  ...
  }, /*#__PURE__*/React.createElement(Details, null), /*#__PURE__*/React.createElement(Link, {
  ...
  }, /*#__PURE__*/React.createElement(PrintIcon, null), "Print")))));
};
...
var Layout = function Layout(_ref) {
  ...
  var renderChart = function renderChart(chart, title) {
    switch (chart.chartType) {
      ...
      case "donut":
        return /*#__PURE__*/React.createElement(CustomPieChart, {
          data: chart,
          title: title
        });

      case "line":
        return /*#__PURE__*/React.createElement(CustomAreaChart, {
          data: chart,
          title: title
        });

      case "horizontalBar":
        return /*#__PURE__*/React.createElement(CustomHorizontalBarChart, {
          data: chart,
          xAxisType: "number",
          yAxisType: "category",
          layout: "vertical",
  ...
  var renderVisualizer = function renderVisualizer(visualizer, key) {
    ...
    switch (visualizer.vizType) {
      case "metric-collection":
        return /*#__PURE__*/React.createElement(GenericChart, {
      ...
      case "performing-metric":
        ...
        return /*#__PURE__*/React.createElement(GenericChart, {
          ...
          key: key
        }, /*#__PURE__*/React.createElement(CustomBarChart, {
      ...
      case "collection":
      case "module":
        return /*#__PURE__*/React.createElement(Summary, (_React$createElement = {
          key: key,
...
var DashBoard = function DashBoard(_ref) {
  ...
  return /*#__PURE__*/React.createElement(FilterContext.Provider, {
  ...
  }, t(dashboardConfig === null || dashboardConfig === void 0 ? void 0 : (_dashboardConfig$8 = dashboardConfig[0]) === null || _dashboardConfig$8 === void 0 ? void 0 : _dashboardConfig$8.name)), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    className: "mrlg"
    ...
    className: "mrsm"
  }), t("ES_DSS_DOWNLOAD")))), /*#__PURE__*/React.createElement(Filters, {
    t: t,
    ulbTenants: ulbTenants,
  ...
  }), (filters === null || filters === void 0 ? void 0 : (_filters$filters2 = filters.filters) === null || _filters$filters2 === void 0 ? void 0 : _filters$filters2.tenantId.length) > 0 && /*#__PURE__*/React.createElement("div", {
    className: "tag-container"
    ...
    onClick: handleClear
  }, t("DSS_FILTER_CLEAR"))), /*#__PURE__*/React.createElement("div", {
    className: "options-m"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(FilterIcon, {
    onClick: function onClick() {
      return setIsFilterModalOpen(!isFilterModalOpen);
    },
    style: true
  })), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(MultiLink, {
    className: "multilink-block-wrapper",
    label: t("ES_DSS_SHARE"),
    icon: /*#__PURE__*/React.createElement(ShareIcon, {
      className: "mrsm"
    ...
    displayOptions: showOptions,
    options: shareOptions
  })), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(DownloadIcon, null), t("ES_DSS_DOWNLOAD"))), dashboardConfig === null || dashboardConfig === void 0 ? void 0 : (_dashboardConfig$9 = dashboardConfig[0]) === null || _dashboardConfig$9 === void 0 ? void 0 : _dashboardConfig$9.visualizations.map(function (row, key) {
...
var DrillDown = function DrillDown() {
  ...
  return /*#__PURE__*/React.createElement(FilterContext.Provider, {
    value: provided
  }, /*#__PURE__*/React.createElement(Header, null, t(title)), /*#__PURE__*/React.createElement(Filters, {
    t: t,
    ulbTenants: ulbTenants,
    ...
    className: "clearText cursorPointer",
    onClick: handleClear
  }, t("DSS_FILTER_CLEAR"))), /*#__PURE__*/React.createElement(GenericChart, {
    header: title,
    showDownload: true,
    showSearch: true,
    className: "fullWidth",
...
var Routes = function Routes(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement(DssBreadCrumb, {
    location: location
  }), /*#__PURE__*/React.createElement(Switch$1, null, /*#__PURE__*/React.createElement(PrivateRoute, {
    ...
    path: path + "/drilldown",
    component: function component() {
      return /*#__PURE__*/React.createElement(DrillDown, null);
    }
  })));
};
