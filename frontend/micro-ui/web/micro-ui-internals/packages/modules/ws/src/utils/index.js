...
export const convertToEditWSUpdate = (data) => {
  let formdata = {
    "WaterConnection": {
      ...
      "status": data?.status,
      "connectionNo": data?.connectionNo || null,
      "oldConnectionNo": null,
      "documents": [...data?.documents?.documents],
      "plumberInfo": data?.plumberInfo || [],
      "roadType": null,
      "roadCuttingArea": null,
      "roadCuttingInfo": [],
      "connectionExecutionDate": data?.connectionExecutionDate || null,
      ...
      "processInstance": data?.isEditApplication ? {
        ...
        ...data?.processInstance, "action" : "SUBMIT_APPLICATION"
      },
      ...
      "pipeSize": data?.pipeSize || null,
      "noOfTaps": data?.noOfTaps || null,
      "waterSourceSubSource": null,
      "waterSubSource" : data?.waterSubSource || null,
