...
const canCancelReceipt = (Receipt = {}) => {
  return (
    ...
    Receipt?.paymentStatus !== "DEPOSITED" &&
    (Receipt?.instrumentStatus == "APPROVED" || Receipt?.instrumentStatus == "REMITTED")
  );
};
          ...
          <Card>
            <StatusTable>
              ...
              <Row
                ...
                text={PaymentReceipt?.paymentDetails[0]?.bill?.consumerCode || "NA"}
              ...
              <Row
                ...
                text={t(convertToLocale(PaymentReceipt?.paymentDetails[0]?.businessService, "BILLINGSERVICE_BUSINESSSERVICE")) || "NA"}
              />
              <Row
                ...
                text={
                  getFinancialYears(
                    ...
                    PaymentReceipt?.paymentDetails[0]?.bill?.billDetails[0]?.toPeriod
                  ) || "NA"
                }
              />
