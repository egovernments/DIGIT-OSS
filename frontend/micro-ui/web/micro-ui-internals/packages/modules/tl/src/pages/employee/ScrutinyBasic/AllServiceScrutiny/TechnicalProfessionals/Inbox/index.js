...
const TechnicalProfessionalInbox = ({
  parentRoute,
  ...
  const { isFetching, isLoading: hookLoading, searchResponseKey, data, searchFields, ...rest } = Digit.Hooks.obps.useTPInbox({
  tenantId,
...
export default TechnicalProfessionalInbox