...
//   displayResidentialGroupHousingForm
  ...
  return (
    <Form onSubmit={DDJAYFormSubmitHandler} style={{ display: props.displayMixedLandUseForm}}>
      <ModalChild
      ...
      <h6 className="text-black">
       <b>Mixed Land Use (Commercial/Residential) in Commerical Zone</b>
        </h6>
