...
const CompositionCluInbox = ({
  ...
  isInbox
    ...
    const { isFetching, isLoading: hookLoading, searchResponseKey, data, searchFields, ...rest } = Digit.Hooks.obps.useCCLUInbox({
    tenantId,
...
export default CompositionCluInbox