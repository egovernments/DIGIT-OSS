...
function DetailsOfAppliedlandDoc (prop)
{
            ...
            <div className="row"> */}
                {/* <div className="col-md-12">                        */}
                    ...
                    {/* {additionalDocResponData?.AdditionalDocumentReport?.map((item) => ( */}
                     ...
                     <tbody>
                        {additionalDocResponData?.AdditionalDocumentReport?.[0]?.detailsOfAppliedland?.map( (input, index)=>(
                            <tr key={index}>                        
                    <td>{index + 1}</td>
                    <td>
...
export default DetailsOfAppliedlandDoc;