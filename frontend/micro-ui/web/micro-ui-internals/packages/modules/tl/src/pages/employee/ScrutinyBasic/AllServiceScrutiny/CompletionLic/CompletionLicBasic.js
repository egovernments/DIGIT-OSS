...
import Completionscrutiny from "./CompletionLic";

// import AddIcon from "@mui/icons-material/Add";

const CompletionLicBasic = ({apiResponse,applicationNumber,refreshScrutinyData,setAdditionalDetails,histeroyData,idwDataTreade,edcDataTreade,applicationStatus }) => {
...
const { remarksData,iconStates,handleGetFiledsStatesById,handleGetRemarkssValues,setBusinessService } = useContext(ScrutinyRemarksContext);
  ...
  useEffect(()=>{
    setBusinessService("COMPLETION_CERTIFICATE");
    if(applicationNumber){
...
export default CompletionLicBasic;
