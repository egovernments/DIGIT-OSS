...
export const PTMyPayments = () => {
  ...
  const {data, isLoading, error} = Digit.Hooks.pt.useMyPropertyPayments({tenantId: "pb.amritsar",filters: {consumerCodes:consumerCode}},{enabled:result?.data?.Properties.length>0?true:false});
