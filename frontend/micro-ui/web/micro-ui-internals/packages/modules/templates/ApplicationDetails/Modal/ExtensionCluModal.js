...
const ExtensionCluModal = ({ t, action, tenantId, state, id, closeModal, submitAction, actionData, applicationData, businessService, moduleCode }) => {
  ...
  function submit(data) {
    ...
    submitAction({
        ...
        extensionOfCLUPermission: [applicationData],
    });
  }
  useEffect(() => {
    if (action) {
...
export default ExtensionCluModal;
