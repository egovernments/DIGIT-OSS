...
const BeneficialModal = ({ t, action, tenantId, state, id, closeModal, submitAction, actionData, applicationData, businessService, moduleCode }) => {
  ...
  function submit(data) {
    ...
    submitAction({
        ...
        changeBeneficial: [applicationData],
    });
  }
  useEffect(() => {
    if (action) {
...
export default BeneficialModal;
