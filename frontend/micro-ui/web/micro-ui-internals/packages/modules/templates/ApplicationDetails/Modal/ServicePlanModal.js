...
const ServicePlanModal = ({ t, action, tenantId, state, id, closeModal, submitAction, actionData, applicationData, businessService, moduleCode }) => {
  ...
  function submit(data) {
    ...
    submitAction({
        ...
        ServicePlanRequest: [applicationData],
    });
  }
  useEffect(() => {
    if (action) {
