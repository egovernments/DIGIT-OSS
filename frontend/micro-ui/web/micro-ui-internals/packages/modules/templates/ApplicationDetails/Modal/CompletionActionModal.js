...
const CompletionLicModal = ({ t, action, tenantId, state, id, closeModal, submitAction, actionData, applicationData, businessService, moduleCode }) => {
  ...
  function submit(data) {
    ...
    submitAction({
        ...
        completionCertificate: [applicationData],
    });
  }
  useEffect(() => {
    if (action) {
...
export default CompletionLicModal;
