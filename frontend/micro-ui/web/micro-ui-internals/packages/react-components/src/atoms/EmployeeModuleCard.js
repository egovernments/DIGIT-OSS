...
const EmployeeModuleCard = ({ Icon, moduleName, kpis = [], links = [], isCitizen = false, className, styles, headerLink = "" }) => {
    ...
    <div className={className ? className : "employeeCard card-home customEmployeeCard"} style={styles ? styles : {}}>
      <div className="complaint-links-container">
        <div className="header" style={isCitizen ? { padding: "0px" } : {}}>
          <span className="text removeHeight" onClick={() => headerLink && history.push(headerLink)}>
            {moduleName}
          </span>
