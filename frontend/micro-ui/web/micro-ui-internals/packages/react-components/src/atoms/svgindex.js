...
const PDFSvg = () => (
  <svg width="84" height="79" viewBox="0 0 84 79" fill="none" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
    <g filter="url(#filter0_d)">
      <rect x="2" y="1" width="80" height="75" fill="url(#pattern0)" />
    </g>
    <defs>
      <filter id="filter0_d" x="0" y="0" width="84" height="79" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
        <feFlood flood-opacity="0" result="BackgroundImageFix" />
      ...
      <pattern id="pattern0" patternContentUnits="objectBoundingBox" width="1" height="1">
        <use xlinkHref="#image0" transform="translate(0 -0.0711443) scale(0.00186567 0.00199005)" />
      </pattern>
      <image
        id="image0"
        width="536"
