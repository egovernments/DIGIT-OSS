...
const ComplaintIcon = ({ className, styles }) => (
  <svg style={{ ...styles }} className={className} viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
    <path
...
const EditPencilIcon = ({ styles, className }) => (
  <svg className={className} style={{ ...styles }} viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
