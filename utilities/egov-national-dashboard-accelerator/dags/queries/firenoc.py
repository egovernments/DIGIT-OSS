...
def extract_firenoc_bundle_metrics(metrics, region_bucket):
  ...
  for department_bucket in department_buckets:
    ...
    slaComplianceProvisional['buckets'].append( { 'name' : department_name, 'value' : department_bucket.get('slaComplianceProvisional').get('slaComplianceProvisional').get('value') if department_bucket.get('slaComplianceProvisional').get('slaComplianceProvisional').get('value')  else 0})
    slaComplianceActual['buckets'].append( { 'name' : department_name, 'value' : department_bucket.get('slaComplianceActual').get('slaComplianceActual').get('value') if  department_bucket.get('slaComplianceActual').get('slaComplianceActual').get('value') else 0})
