...
import org.egov.commons.repository.builder.CategoryQueryBuilder;
...
public class CategoryRepository {
	...
	public List<Category> findForCriteria(CategoryGetRequest categoryGetRequest) {
		List<Object> preparedStatementValues = new ArrayList<Object>();
		String queryStr = categoryQueryBuilder.getQuery(categoryGetRequest, preparedStatementValues);
		List<Category> categories = jdbcTemplate.query(queryStr, preparedStatementValues.toArray(), categoryRowMapper);
		return categories;
	}
}