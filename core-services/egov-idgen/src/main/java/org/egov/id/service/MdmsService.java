...
public class MdmsService {
    ...
    private String string1="PARSING ERROR";
    ...
    public String getCity(RequestInfo requestInfo, IdRequest idRequest) {
        ...
        try {
            ...
            if(cityCode== null){
                throw new CustomException(string1, "City code is Null/not valid");
            }
        } catch (Exception e) {
            // TODO Auto-generated catch block
            log.error("Error occurred while fetching city code", e);
            throw new CustomException(string1, "Failed to get citycode from MDMS");
        }
        return cityCode;
    }
    ...
    public String getIdFormat(RequestInfo requestInfo, IdRequest idRequest) {
        ...
        try {
            ...
            throw new CustomException(string1, "Failed to get formatid from MDMS");
        }
        return idFormat;
    }
    ...
    private Map<String, String> doMdmsServiceCall(RequestInfo requestInfo, IdRequest idRequest) {
        ...
        try {
            ...
            throw new CustomException(string1, "Failed to get citycode/formatid from MDMS");
        }
