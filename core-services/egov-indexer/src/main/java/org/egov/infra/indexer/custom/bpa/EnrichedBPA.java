...
public class EnrichedBPA {
  ...
  private EnrichedLandInfo landInfo = null;
  ...
  public EnrichedBPA id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EnrichedBPA applicationNo(String applicationNo) {
  ...
  **/
  ...
  public EnrichedBPA approvalNo(String approvalNo) {
  ...
  **/
  ...
  public EnrichedBPA accountId(String accountId) {
  ...
  **/
  ...
  public EnrichedBPA edcrNumber(String edcrNumber) {
  ...
  **/
  ...
  public EnrichedBPA riskType(String riskType) {
  ...
  **/
  ...
  public EnrichedBPA approvalDate(Long approvalDate) {
  ...
  **/
  ...
  public EnrichedBPA applicationDate(Long applicationDate) {
  ...
  public EnrichedBPA businessService(String businessService) {
  ...
  public EnrichedBPA landId(String landId) {
    this.landId = landId;
    return this;
  }
  ...
  **/
  ...
  public EnrichedBPA tenantId(String tenantId) {
  ...
  **/
  ...
  public EnrichedBPA status(String status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public EnrichedBPA documents(List<Document> documents) {
    this.documents = documents;
    return this;
  }

  public EnrichedBPA addDocumentsItem(Document documentsItem) {
  ...
  **/
  ...
  public EnrichedBPA landInfo(EnrichedLandInfo landInfo) {
  ...
  **/
    ...
    @Valid
    public EnrichedLandInfo getLandInfo() {
    return landInfo;
  }

  public void setLandInfo(EnrichedLandInfo landInfo) {
    this.landInfo = landInfo;
  }

  public EnrichedBPA workflow(Workflow workflow) {
  ...
  **/
  ...
  public EnrichedBPA auditDetails(AuditDetails auditDetails) {
  ...
  **/
  ...
  public EnrichedBPA additionalDetails(Object additionalDetails) {
