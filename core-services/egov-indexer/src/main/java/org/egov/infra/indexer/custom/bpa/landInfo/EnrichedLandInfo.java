...
public class EnrichedLandInfo {
  ...
  public EnrichedLandInfo id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EnrichedLandInfo landUId(String landUId) {
  ...
  **/
  ...
  public EnrichedLandInfo landUniqueRegNo(String landUniqueRegNo) {
  ...
  **/
  ...
  public EnrichedLandInfo tenantId(String tenantId) {
  ...
  **/
  ...
  public EnrichedLandInfo status(Status status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public EnrichedLandInfo address(Address address) {
  ...
  **/
  ...
  public EnrichedLandInfo ownershipCategory(String ownershipCategory) {
  ...
  **/
  ...
  public EnrichedLandInfo owners(List<OwnerInfo> owners) {
    this.owners = owners;
    return this;
  }

  public EnrichedLandInfo addOwnersItem(OwnerInfo ownersItem) {
  ...
  **/
  ...
  public EnrichedLandInfo institution(Institution institution) {
  ...
  **/
  ...
  public EnrichedLandInfo source(Source source) {
    this.source = source;
    return this;
  }
  ...
  **/
  ...
  public EnrichedLandInfo channel(Channel channel) {
  ...
  **/
  ...
  public EnrichedLandInfo documents(List<Document> documents) {
    this.documents = documents;
    return this;
  }

  public EnrichedLandInfo addDocumentsItem(Document documentsItem) {
  ...
  **/
  ...
  public EnrichedLandInfo unit(List<EnrichedUnit> unit) {
    this.unit = unit;
    return this;
  }

  public EnrichedLandInfo addUnitItem(EnrichedUnit unitItem) {
    if (this.unit == null) {
      this.unit = new ArrayList<EnrichedUnit>();
    }
  ...
  **/
      @Valid
    public List<EnrichedUnit> getUnit() {
    return unit;
  }

  public void setUnit(List<EnrichedUnit> unit) {
    this.unit = unit;
  }

  public EnrichedLandInfo additionalDetails(Object additionalDetails) {
  ...
  **/
  ...
  public EnrichedLandInfo auditDetails(AuditDetails auditDetails) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    EnrichedLandInfo landInfo = (EnrichedLandInfo) o;
