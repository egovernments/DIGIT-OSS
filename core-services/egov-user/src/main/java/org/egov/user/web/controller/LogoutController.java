...
public class LogoutController {
    ...
    public ResponseInfo deleteToken(@RequestBody TokenWrapper tokenWrapper) throws Exception {
        ...
        return new ResponseInfo("", "", Long.valueOf(new Date().toString()), "", "", "Logout successfully");
    }
    ...
    public ResponseEntity<ErrorResponse> handleError(Exception ex) {
        ...
        ResponseInfo responseInfo = new ResponseInfo("", "", Long.valueOf(new Date().toString()), "", "", "Logout failed");
