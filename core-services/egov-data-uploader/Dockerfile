FROM egovio/apline-jre:8u121-uploader
...
# "mvn clean package"
RUN cd /data && git pull origin master

COPY /target/egov-data-uploader-0.0.1-SNAPSHOT.jar /opt/egov/egov-data-uploader.jar
