...
public interface VoucherService {
	public VoucherResponse createReceiptVoucher(ReceiptReq req, FinanceMdmsModel finSerMdms, String collectionVersion) ;
	public VoucherResponse cancelReceiptVoucher(ReceiptReq req,  String tenantId, Set<String> voucherNumbers) ;
