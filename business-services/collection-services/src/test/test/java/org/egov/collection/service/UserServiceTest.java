...
class UserServiceTest {
    ...
    void testGetUser() {
        ...
        this.userService.getUser(new RequestInfo(), "4105551212", "42");
    }
    ...
    void testCreateUser() {
        ...
        this.userService.createUser(new PaymentRequest());
    }

    /**
     * Method under test: {@link UserService#createUser(RequestInfo, Bill)}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testCreateUser2() {
        ...
        this.userService.createUser(requestInfo, new Bill());
    }
}
