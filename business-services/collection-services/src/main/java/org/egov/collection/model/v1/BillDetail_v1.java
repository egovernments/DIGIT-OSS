...
public class BillDetail_v1 {
    ...
    private List<BillAccountDetail_v1> billAccountDetails = null;
    ...
    public Boolean addBillAccountDetail(BillAccountDetail_v1 billAccountDetail) {
