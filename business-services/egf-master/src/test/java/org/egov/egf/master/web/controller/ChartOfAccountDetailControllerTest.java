...
public class ChartOfAccountDetailControllerTest {
	...
	private List<ChartOfAccountDetail> getChartOfAccountDetails(){
		...
		AccountDetailType accountDetailType = AccountDetailType.builder().id(CODE_E6).name(FINAL).description(FINAL).tableName(FINAL).active(true).fullyQualifiedName(FINAL).build();
